 ...
 * <P>
 * Type-safe enumerators are a way of listing pre-defined lists of things,
...
//    return ""+this.getClass() + ":" + text;   //for testing
    ...
    * the class will always be TypeSafeEnumerator...
    */
   ...
   public static TypeSafeEnumerator getFor(Class aClass, String aString)
   {
      ...
      throw new IllegalArgumentException("No "+aClass+" found for '"+aString+"'");
