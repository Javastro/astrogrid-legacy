/*
 * $Id: MetadataInitialiser.java,v 1.1 2004/08/30 17:14:44 mch Exp $
 *
...
public class MetadataInitialiser
{
   protected static Log log = LogFactory.getLog(MetadataInitialiser.class);

   public MetadataInitialiser() {
   }
   ...
   public static void main(String[] args) throws IOException {
      DomHelper.DocumentToStream(MetadataInitialiser.generateMetadata(), System.out);
