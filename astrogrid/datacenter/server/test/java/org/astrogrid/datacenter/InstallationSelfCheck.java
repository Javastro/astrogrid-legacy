/*$Id: InstallationSelfCheck.java,v 1.1 2003/11/28 16:10:30 nw Exp $
...
public class InstallationSelfCheck extends TestCase {
    ...
    public void testLoadSpi() {
        String spiClass = SimpleConfig.getProperty(QuerierManager.QUERIER_SPI_KEY);
        assertNotNull(QuerierManager.QUERIER_SPI_KEY + " is not defined",spiClass);
        Class clazz = null;
        try {
