/*$Id: MySqlQueryTranslator.java,v 1.1 2003/09/02 14:46:34 nw Exp $
...
* @todo split this into a core SQL translator and a mysql-specific.
* @todo improve parenthesizing of complex expressions
* @todo read ADQL spec and check all is correct.
 */
public class MySqlQueryTranslator extends QueryTranslator {
...
// group by clause
   ...
   public void visit(StringLiteral e) {
       ...
       String strArr = StringUtils.join(as.getString()," ");
