   ...
   private Operation
    ...
    public Return( Element returnElement, Catalog catalog ) throws QueryException {
      ...
      try {
         ...
         NodeList
            nodeList = returnElement.getElementsByTagName( AdqlTags.FIELD_ELEMENT ) ;
         ...
         for( int i=0 ; i < nodeList.getLength() ; i++ ) {
            ...
            if( fieldElement.getTagName().equals( AdqlTags.FIELD_ELEMENT ) ) {
   ...
   public String toSQLString() {
      ...
      try {
          ...
          while ( iterator.hasNext() ){
            ...
            if ( field.getType().equals(AdqlTags.FIELD_TYPE_PASSTHROUGH ) ) {
               buffer
                   .append( " " )
                ...
                if ( field.getType().equals(AdqlTags.FIELD_TYPE_UCD)) {
                   buffer.append(getColumnHeading( catalog, field.getName()) );
                }
                else if (field.getType().equals(AdqlTags.FIELD_TYPE_COLUMN)) {
                   buffer.append(getColumnHeading( catalog, field.getName()) );
                }
