 ...
 * Schema.
 * $Id: Atom.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof Atom) {
            ...
            if (this._stringLiteral != null) {
                if (temp._stringLiteral == null) return false;
                else if (!(this._stringLiteral.equals(temp._stringLiteral))) 
                    return false;
            }
            else if (temp._stringLiteral != null)
                return false;
            if (this._numberLiteral != null) {
                if (temp._numberLiteral == null) return false;
                else if (!(this._numberLiteral.equals(temp._numberLiteral))) 
                    return false;
            }
            else if (temp._numberLiteral != null)
                return false;
            return true;
        }
        return false;
