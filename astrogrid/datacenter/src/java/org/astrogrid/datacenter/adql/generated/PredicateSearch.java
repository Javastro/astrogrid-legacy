 ...
 * Schema.
 * $Id: PredicateSearch.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof PredicateSearch) {
        
            PredicateSearch temp = (PredicateSearch)obj;
            if (this._likePred != null) {
                if (temp._likePred == null) return false;
                else if (!(this._likePred.equals(temp._likePred))) 
                    return false;
            }
            else if (temp._likePred != null)
                return false;
            if (this._comparisonPred != null) {
                if (temp._comparisonPred == null) return false;
                else if (!(this._comparisonPred.equals(temp._comparisonPred))) 
                    return false;
            }
            else if (temp._comparisonPred != null)
                return false;
            if (this._betweenPred != null) {
                if (temp._betweenPred == null) return false;
                else if (!(this._betweenPred.equals(temp._betweenPred))) 
                    return false;
            }
            else if (temp._betweenPred != null)
                return false;
            return true;
        }
        return false;
