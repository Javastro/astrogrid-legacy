 ...
 * Schema.
 * $Id: BetweenPred.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof BetweenPred) {
        
            BetweenPred temp = (BetweenPred)obj;
            if (this._expr != null) {
                ...
                return false;
            if (this._negate != temp._negate)
                return false;
            if (this._has_negate != temp._has_negate)
                return false;
