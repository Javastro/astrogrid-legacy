 ...
 * Schema.
 * $Id: Select.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof Select) {
            ...
            if (this._optionalAllOrDistinct != null) {
                if (temp._optionalAllOrDistinct == null) return false;
                else if (!(this._optionalAllOrDistinct.equals(temp._optionalAllOrDistinct))) 
                    return false;
            }
            else if (temp._optionalAllOrDistinct != null)
                return false;
            if (this._selectChoice != null) {
                if (temp._selectChoice == null) return false;
                else if (!(this._selectChoice.equals(temp._selectChoice))) 
                    return false;
            }
            else if (temp._selectChoice != null)
                return false;
            if (this._tableClause != null) {
                if (temp._tableClause == null) return false;
                else if (!(this._tableClause.equals(temp._tableClause))) 
                    return false;
            }
            else if (temp._tableClause != null)
                return false;
            if (this._orderBy != null) {
                if (temp._orderBy == null) return false;
                else if (!(this._orderBy.equals(temp._orderBy))) 
                    return false;
            }
            else if (temp._orderBy != null)
                return false;
            return true;
        }
        return false;
