 ...
 * Schema.
 * $Id: ArchiveTable.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ArchiveTable) {
            ...
            ArchiveTable temp = (ArchiveTable)obj;
            if (this._archive != null) {
                if (temp._archive == null) return false;
                else if (!(this._archive.equals(temp._archive))) 
                    return false;
            }
            else if (temp._archive != null)
                return false;
            return true;
        }
        return false;
