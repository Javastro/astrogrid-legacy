 ...
 * Schema.
 * $Id: IntersectionSearch.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof IntersectionSearch) {
        
            IntersectionSearch temp = (IntersectionSearch)obj;
            if (this._firstCondition != null) {
                if (temp._firstCondition == null) return false;
                else if (!(this._firstCondition.equals(temp._firstCondition))) 
                    return false;
            }
            else if (temp._firstCondition != null)
                return false;
            if (this._secondCondition != null) {
                if (temp._secondCondition == null) return false;
                else if (!(this._secondCondition.equals(temp._secondCondition))) 
                    return false;
            }
            else if (temp._secondCondition != null)
                return false;
            return true;
        }
        return false;
