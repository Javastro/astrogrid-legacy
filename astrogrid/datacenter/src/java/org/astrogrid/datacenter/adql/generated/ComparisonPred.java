 ...
 * Schema.
 * $Id: ComparisonPred.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ComparisonPred) {
        
            ComparisonPred temp = (ComparisonPred)obj;
            ...
            if (this._compare != null) {
                if (temp._compare == null) return false;
                else if (!(this._compare.equals(temp._compare))) 
                    return false;
            }
            else if (temp._compare != null)
                return false;
