 ...
 * Schema.
 * $Id: TableExpression.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof TableExpression) {
            ...
            TableExpression temp = (TableExpression)obj;
            if (this._fromClause != null) {
                if (temp._fromClause == null) return false;
                else if (!(this._fromClause.equals(temp._fromClause))) 
                    return false;
            }
            else if (temp._fromClause != null)
                return false;
            if (this._whereClause != null) {
                if (temp._whereClause == null) return false;
                else if (!(this._whereClause.equals(temp._whereClause))) 
                    return false;
            }
            else if (temp._whereClause != null)
                return false;
            if (this._groupByClause != null) {
                if (temp._groupByClause == null) return false;
                else if (!(this._groupByClause.equals(temp._groupByClause))) 
                    return false;
            }
            else if (temp._groupByClause != null)
                return false;
            if (this._havingClause != null) {
                if (temp._havingClause == null) return false;
                else if (!(this._havingClause.equals(temp._havingClause))) 
                    return false;
            }
            else if (temp._havingClause != null)
                return false;
            return true;
        }
        return false;
