 ...
 * Schema.
 * $Id: From.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof From) {
            ...
            From temp = (From)obj;
            if (this._tableReference != null) {
                if (temp._tableReference == null) return false;
                else if (!(this._tableReference.equals(temp._tableReference))) 
                    return false;
            }
            else if (temp._tableReference != null)
                return false;
            return true;
        }
        return false;
