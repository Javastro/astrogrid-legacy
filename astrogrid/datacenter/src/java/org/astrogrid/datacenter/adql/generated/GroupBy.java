 ...
 * Schema.
 * $Id: GroupBy.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof GroupBy) {
            ...
            GroupBy temp = (GroupBy)obj;
            if (this._groupByChoiceList != null) {
                if (temp._groupByChoiceList == null) return false;
                else if (!(this._groupByChoiceList.equals(temp._groupByChoiceList))) 
                    return false;
            }
            else if (temp._groupByChoiceList != null)
                return false;
            return true;
        }
        return false;
