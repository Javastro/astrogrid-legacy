 ...
 * Schema.
 * $Id: ArrayOfOrder.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ArrayOfOrder) {
        
            ArrayOfOrder temp = (ArrayOfOrder)obj;
            if (this._orderList != null) {
                if (temp._orderList == null) return false;
                else if (!(this._orderList.equals(temp._orderList))) 
                    return false;
            }
            else if (temp._orderList != null)
                return false;
            return true;
        }
        return false;
