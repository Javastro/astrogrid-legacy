 ...
 * Schema.
 * $Id: Function.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof Function) {
            ...
            if (this._functionReference != null) {
                if (temp._functionReference == null) return false;
                else if (!(this._functionReference.equals(temp._functionReference))) 
                    return false;
            }
            else if (temp._functionReference != null)
                return false;
            return true;
        }
        return false;
