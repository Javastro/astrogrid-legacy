 ...
 * Schema.
 * $Id: ColumnExpr.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
 ...
 */
public class ColumnExpr extends org.astrogrid.datacenter.adql.generated.ScalarExpression 
implements java.io.Serializable
{
    ...
    public ColumnExpr() {
        super();
    } //-- org.astrogrid.datacenter.adql.generated.ColumnExpr()
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ColumnExpr) {
            ...
            ColumnExpr temp = (ColumnExpr)obj;
            if (this._allColumnReference != null) {
                if (temp._allColumnReference == null) return false;
                else if (!(this._allColumnReference.equals(temp._allColumnReference))) 
                    return false;
            }
            else if (temp._allColumnReference != null)
                return false;
            if (this._singleColumnReference != null) {
                if (temp._singleColumnReference == null) return false;
                else if (!(this._singleColumnReference.equals(temp._singleColumnReference))) 
                    return false;
            }
            else if (temp._singleColumnReference != null)
                return false;
            return true;
        }
        return false;
     ...
     * @param reader
     */
    public static org.astrogrid.datacenter.adql.generated.ColumnExpr unmarshalColumnExpr(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.astrogrid.datacenter.adql.generated.ColumnExpr) Unmarshaller.unmarshal(org.astrogrid.datacenter.adql.generated.ColumnExpr.class, reader);
    } //-- org.astrogrid.datacenter.adql.generated.ColumnExpr unmarshalColumnExpr(java.io.Reader) 
