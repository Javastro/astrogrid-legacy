 ...
 * Schema.
 * $Id: ArrayOfString.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof ArrayOfString) {
            ...
            ArrayOfString temp = (ArrayOfString)obj;
            if (this._stringList != null) {
                if (temp._stringList == null) return false;
                else if (!(this._stringList.equals(temp._stringList))) 
                    return false;
            }
            else if (temp._stringList != null)
                return false;
            return true;
        }
        return false;
