 ...
 * Schema.
 * $Id: GroupByChoice.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof GroupByChoice) {
        
            GroupByChoice temp = (GroupByChoice)obj;
            if (this.groupByChoiceItem != null) {
                if (temp.groupByChoiceItem == null) return false;
                else if (!(this.groupByChoiceItem.equals(temp.groupByChoiceItem))) 
                    return false;
            }
            else if (temp.groupByChoiceItem != null)
                return false;
            return true;
        }
        return false;
