 ...
 * Schema.
 * $Id: SelectionListChoice.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof SelectionListChoice) {
        
            SelectionListChoice temp = (SelectionListChoice)obj;
            if (this.selectionListChoiceItem != null) {
                if (temp.selectionListChoiceItem == null) return false;
                else if (!(this.selectionListChoiceItem.equals(temp.selectionListChoiceItem))) 
                    return false;
            }
            else if (temp.selectionListChoiceItem != null)
                return false;
            return true;
        }
        return false;
