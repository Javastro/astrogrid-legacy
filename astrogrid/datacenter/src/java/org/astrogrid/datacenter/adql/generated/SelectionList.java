 ...
 * Schema.
 * $Id: SelectionList.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof SelectionList) {
            ...
            SelectionList temp = (SelectionList)obj;
            if (this._selectionListChoiceList != null) {
                if (temp._selectionListChoiceList == null) return false;
                else if (!(this._selectionListChoiceList.equals(temp._selectionListChoiceList))) 
                    return false;
            }
            else if (temp._selectionListChoiceList != null)
                return false;
            return true;
        }
        return false;
