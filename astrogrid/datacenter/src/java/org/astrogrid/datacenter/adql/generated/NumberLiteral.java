 ...
 * Schema.
 * $Id: NumberLiteral.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof NumberLiteral) {
            ...
            NumberLiteral temp = (NumberLiteral)obj;
            if (this._intNum != null) {
                if (temp._intNum == null) return false;
                else if (!(this._intNum.equals(temp._intNum))) 
                    return false;
            }
            else if (temp._intNum != null)
                return false;
            if (this._approxNum != null) {
                if (temp._approxNum == null) return false;
                else if (!(this._approxNum.equals(temp._approxNum))) 
                    return false;
            }
            else if (temp._approxNum != null)
                return false;
            return true;
        }
        return false;
