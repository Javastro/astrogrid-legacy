 ...
 * Schema.
 * $Id: Table.java,v 1.1 2003/08/28 15:27:54 nw Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof Table) {
            ...
            if (this._aliasName != null) {
                if (temp._aliasName == null) return false;
                else if (!(this._aliasName.equals(temp._aliasName))) 
                    return false;
            }
            else if (temp._aliasName != null)
                return false;
            return true;
        }
        return false;
