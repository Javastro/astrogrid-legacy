/*$Id: FactoryProviderTest.java,v 1.1 2003/08/21 12:29:18 nw Exp $
 ...
 *
 */
public abstract class FactoryProviderTest extends TestCase {

    /**
     * 
     */
    public FactoryProviderTest(String name) {
        super(name);
    }
    ...
    public void testEmptyFactoryManager() throws QueryException {
        ...
        assertNull(fac.getMySpaceFactory());        
    ...
    public void testPopulatedFactoryManager() throws QueryException {
         ...
         assertNotNull(fac.getMySpaceFactory());        
...
/* 
$Log: FactoryProviderTest.java,v $
