...
public class VizieRServiceLocator extends org.apache.axis.client.Service implements org.astrogrid.datacenter.cdsdelegate.vizier.VizieRService {
    ...
    public org.astrogrid.datacenter.cdsdelegate.vizier.VizieR getVizieR(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.astrogrid.datacenter.cdsdelegate.vizier.VizieRSoapBindingStub _stub = new org.astrogrid.datacenter.cdsdelegate.vizier.VizieRSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.astrogrid.datacenter.cdsdelegate.vizier.VizieR.class.isAssignableFrom(serviceEndpointInterface)) {
                org.astrogrid.datacenter.cdsdelegate.vizier.VizieRSoapBindingStub _stub = new org.astrogrid.datacenter.cdsdelegate.vizier.VizieRSoapBindingStub(new java.net.URL(VizieR_address), this);
                _stub.setPortName(getVizieRWSDDServiceName());
                return _stub;
            }
        }
