/*
 * $Id: StreamTarget.java,v 1.1 2004/11/09 17:42:22 mch Exp $
 *
...
public class StreamTarget implements TargetIndicator  {
   ...
   /** Creates targetIndicator to wrap given stream.  Set closeIt to true to
    * tell users of the stream to close it when they've finished with it, false
    * if not
    */
   public StreamTarget(OutputStream targetOut, boolean closeIt) {
      this.out = targetOut;
