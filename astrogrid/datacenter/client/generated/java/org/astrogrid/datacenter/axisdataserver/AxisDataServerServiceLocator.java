...
public class AxisDataServerServiceLocator extends org.apache.axis.client.Service implements org.astrogrid.datacenter.axisdataserver.AxisDataServerService {
    ...
    public org.astrogrid.datacenter.axisdataserver.AxisDataServer getAxisDataServer() throws javax.xml.rpc.ServiceException {
    ...
    public org.astrogrid.datacenter.axisdataserver.AxisDataServer getAxisDataServer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.astrogrid.datacenter.axisdataserver.AxisDataServerSoapBindingStub _stub = new org.astrogrid.datacenter.axisdataserver.AxisDataServerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.astrogrid.datacenter.axisdataserver.AxisDataServer.class.isAssignableFrom(serviceEndpointInterface)) {
                org.astrogrid.datacenter.axisdataserver.AxisDataServerSoapBindingStub _stub = new org.astrogrid.datacenter.axisdataserver.AxisDataServerSoapBindingStub(new java.net.URL(AxisDataServer_address), this);
                _stub.setPortName(getAxisDataServerWSDDServiceName());
                return _stub;
            }
        }
