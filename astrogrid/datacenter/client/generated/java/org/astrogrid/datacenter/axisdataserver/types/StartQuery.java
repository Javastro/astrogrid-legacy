 ...
 * Schema.
 * $Id: StartQuery.java,v 1.4 2003/11/21 17:30:19 nw Exp $
 */
...
public class StartQuery implements java.io.Serializable {
    ...
    public StartQuery() {
        super();
    } //-- org.astrogrid.datacenter.axisdataserver.types.StartQuery()
    ...
    /**
     * Method unmarshalStartQuery
     * 
     * @param reader
     */
    public static org.astrogrid.datacenter.axisdataserver.types.StartQuery unmarshalStartQuery(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.astrogrid.datacenter.axisdataserver.types.StartQuery) Unmarshaller.unmarshal(org.astrogrid.datacenter.axisdataserver.types.StartQuery.class, reader);
    } //-- org.astrogrid.datacenter.axisdataserver.types.StartQuery unmarshalStartQuery(java.io.Reader) 
