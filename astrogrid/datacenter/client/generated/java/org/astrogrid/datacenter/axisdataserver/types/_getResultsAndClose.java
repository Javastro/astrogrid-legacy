...
public class _getResultsAndClose  implements java.io.Serializable {
    private org.astrogrid.datacenter.axisdataserver.types._QueryId queryId;

    public _getResultsAndClose() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getResultsAndClose)) return false;
        _getResultsAndClose other = (_getResultsAndClose) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getResultsAndClose.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.astrogrid.org/datacenter/It04/dataserver/v1/types", ">getResultsAndClose"));
