 ...
 * Schema.
 * $Id: OrderDescriptor.java,v 1.12 2004/01/13 00:31:23 nw Exp $
 */
...
public class OrderDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OrderDescriptor() {
        ...
        //-- _option
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.datacenter.adql.generated.OrderOption.class, "_option", "Option", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Order target = (Order) object;
                    target.setOption( (org.astrogrid.datacenter.adql.generated.OrderOption) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.datacenter.adql.generated.OrderOption();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://tempuri.org/adql");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.datacenter.adql.generated.OrderDescriptor()
    ...
    {
        return org.astrogrid.datacenter.adql.generated.Order.class;
