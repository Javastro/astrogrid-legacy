 ...
 * Schema.
 * $Id: Coord3SizeTypeDescriptor.java,v 1.2 2004/03/26 16:03:33 eca Exp $
 */
...
/**
 * Class Coord3SizeTypeDescriptor.
 * 
 * @version $Revision: 1.2 $ $Date: 2004/03/26 16:03:33 $
 */
public class Coord3SizeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public Coord3SizeTypeDescriptor() {
        super();
        nsURI = "urn:nvo-coords";
        xmlName = "coord3SizeType";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Coord3SizeType target = (Coord3SizeType) object;
        ...
        //-- _posAngleRef
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Object.class, "_posAngleRef", "PosAngleRef", org.exolab.castor.xml.NodeType.Element);
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Coord3SizeType target = (Coord3SizeType) object;
                    target.addPosAngleRef( (java.lang.Object) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _posAngleRef
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _matrix
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.datacenter.adql.generated.ogsadai.ArrayOfDouble.class, "_matrix", "Matrix", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Coord3SizeType target = (Coord3SizeType) object;
                    target.setMatrix( (org.astrogrid.datacenter.adql.generated.ogsadai.ArrayOfDouble) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _posAngle
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.datacenter.adql.generated.ogsadai.ArrayOfDouble.class, "_posAngle", "PosAngle", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Coord3SizeType target = (Coord3SizeType) object;
                return target.getPosAngle();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Coord3SizeType target = (Coord3SizeType) object;
                    target.setPosAngle( (org.astrogrid.datacenter.adql.generated.ogsadai.ArrayOfDouble) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.datacenter.adql.generated.ogsadai.Coord3SizeTypeDescriptor()
    ...
    {
        return org.astrogrid.datacenter.adql.generated.ogsadai.Coord3SizeType.class;
