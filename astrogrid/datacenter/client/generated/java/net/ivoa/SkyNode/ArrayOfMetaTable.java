...
public class ArrayOfMetaTable  implements java.io.Serializable {
    private net.ivoa.SkyNode.MetaTable[] metaTable;

    public ArrayOfMetaTable() {
    }

    public net.ivoa.SkyNode.MetaTable[] getMetaTable() {
        return metaTable;
    }

    public void setMetaTable(net.ivoa.SkyNode.MetaTable[] metaTable) {
        this.metaTable = metaTable;
    }

    public net.ivoa.SkyNode.MetaTable getMetaTable(int i) {
        return metaTable[i];
    }

    public void setMetaTable(int i, net.ivoa.SkyNode.MetaTable value) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfMetaTable.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("SkyNode.ivoa.net", "ArrayOfMetaTable"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("metaTable");
        elemField.setXmlName(new javax.xml.namespace.QName("SkyNode.ivoa.net", "MetaTable"));
