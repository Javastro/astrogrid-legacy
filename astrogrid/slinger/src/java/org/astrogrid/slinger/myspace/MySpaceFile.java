/*
 * $Id: MySpaceFile.java,v 1.2 2004/12/07 01:33:36 jdt Exp $
 *
...
import org.astrogrid.store.delegate.myspaceItn05.AstrogridMyspaceSoapBindingStub;
...
//      KernelResults kresults = soapClient.getEntriesList(path+"*", false);
      ...
      org.astrogrid.store.delegate.StoreFile oldTree = delegate.getFile(searchPath);
   ...
   private static void loadFileDetails(MySpaceFile file, org.astrogrid.store.delegate.StoreFile oldTree) throws IOException {
...
//      KernelResults kresults = soapClient.getEntriesList(path+"*", false);
      ...
      org.astrogrid.store.delegate.StoreFile oldTree = temp.getFiles(searchPath);
      System.out.println("...got results");
...
//         throw new IOException("No entries found at "+searchPath+" on "+soapClient);
   ...
   private static void loadDetails(MySpaceFile file, org.astrogrid.store.delegate.StoreFile oldTree) throws IOException {
