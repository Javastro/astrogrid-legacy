...
public class ManagerServiceLocator extends org.apache.axis.client.Service implements ManagerService {
    ...
    public Manager getAstrogridMyspace(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            AstrogridMyspaceSoapBindingStub _stub = new AstrogridMyspaceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Manager.class.isAssignableFrom(serviceEndpointInterface)) {
                AstrogridMyspaceSoapBindingStub _stub = new AstrogridMyspaceSoapBindingStub(new java.net.URL(AstrogridMyspace_address), this);
                _stub.setPortName(getAstrogridMyspaceWSDDServiceName());
                return _stub;
            }
        }
