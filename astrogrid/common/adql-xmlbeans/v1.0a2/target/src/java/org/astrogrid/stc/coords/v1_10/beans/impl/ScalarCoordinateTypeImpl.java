 ...
 */
public class ScalarCoordinateTypeImpl extends org.astrogrid.stc.coords.v1_10.beans.impl.CoordinateTypeImpl implements org.astrogrid.stc.coords.v1_10.beans.ScalarCoordinateType
{
    
    public ScalarCoordinateTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCValue()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CVALUE$1) != 0;
        }
    }
    ...
    public void unsetCValue()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CVALUE$1, 0);
        }
    }
    ...
    public org.apache.xmlbeans.XmlObject insertNewCError(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlObject target = null;
            target = (org.apache.xmlbeans.XmlObject)get_store().insert_element_user(CERROR$2, i);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlObject insertNewCResolution(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlObject target = null;
            target = (org.apache.xmlbeans.XmlObject)get_store().insert_element_user(CRESOLUTION$4, i);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlObject insertNewCSize(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlObject target = null;
            target = (org.apache.xmlbeans.XmlObject)get_store().insert_element_user(CSIZE$6, i);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlObject insertNewCPixSize(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlObject target = null;
            target = (org.apache.xmlbeans.XmlObject)get_store().insert_element_user(CPIXSIZE$8, i);
            return target;
        }
    }
