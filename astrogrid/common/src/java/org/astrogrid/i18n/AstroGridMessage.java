...
public class AstroGridMessage {
	...
	private static final String
        ...
        ASTROGRIDERROR_MESSAGE_NOT_FOUND_IN_RESOURCEBUNDLE = 
           "AG{0}Z00005:AstroGridMessage: Message with key [{1}] not found in ResourceBundle [{2}]" ,
	...
	public String toString( ResourceBundle mssgs ) {
		...
		try {
			...
			Object[]
			   oa = { key, mssgs.getLocale().toString() } ;
            retValue = generateErrantMessage( mssgs
                                            , ASTROGRIDERROR_MESSAGE_NOT_FOUND_IN_RESOURCEBUNDLE
                                            , oa ) ;
	...
	**/
    public String toString() {
	   ...
	   try {
           ...
           if( key != null
               &&
               key.startsWith( Z_MESSAGE_PREFIX_PATTERN ) ) {
