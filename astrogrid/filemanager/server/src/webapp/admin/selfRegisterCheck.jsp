...
<html>
<head>
<title>AstroGrid FileManager Register</title>
...
<%
if(request.getParameter("addFromText") != null &&
   "true".equals(request.getParameter("addFromText"))) {
...
<%}%>
<p>
You will be publishing this at:  <%out.print(SimpleConfig.getSingleton().getString("org.astrogrid.registry.admin.endpoint"));%>
</p>
<br/>
