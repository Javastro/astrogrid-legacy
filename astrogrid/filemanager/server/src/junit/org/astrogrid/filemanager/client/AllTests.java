...
public class AllTests {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(
                "Test for FileManager - Client");
        //$JUnit-BEGIN$
        suite.addTestSuite(SoapFileManagerClientTestCase.class);
        //$JUnit-END$    
        return suite;
    }
}
...
Revision 1.1.2.4  2005/02/18 15:50:14  nw
lots of changes.
introduced new schema-driven soap binding, got soap-based unit tests
working again (still some failures)

Revision 1.1.2.3  2005/02/11 17:39:08  nw
suite of non-soap tests.
