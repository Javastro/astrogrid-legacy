/*
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/filemanager/server/src/junit/org/astrogrid/filemanager/client/delegate/SoapNodeTestCase.java,v $</cvs:source>
 * <cvs:author>$Author: clq2 $</cvs:author>
 * <cvs:date>$Date: 2005/03/11 13:37:06 $</cvs:date>
 * <cvs:version>$Revision: 1.2 $</cvs:version>
 * <cvs:log>
 *   $Log: SoapNodeTestCase.java,v $
 ...
 *  
 */
public class SoapNodeTestCase extends
        NodeTest {


    /**
     * @see org.astrogrid.filemanager.client.delegate.NodeTest#createDelegate()
     */
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(SoapNodeTestCase.class.getName());
        TestSuite tests = new TestSuite(SoapNodeTestCase.class);
