...
import org.astrogrid.storebrowser.tree.FilePopupMenu;
import org.astrogrid.storebrowser.tree.FolderPopupMenu;
...
{
   static Log log = LogFactory.getLog(DirectoryListView.class);
