SELECT * FROM INSERT_NAME_CATALOG.INSERT_NAME_TABLE AS a WHERE 
   ...
   ( 
      ACOS( 
         ( SIN(RADIANS(a."INSERT_NAME_DEC")) * SIN(INSERT_VALUE_DEC_RAD) )  +  
         ( COS(RADIANS(a."INSERT_NAME_DEC")) * COS(INSERT_VALUE_DEC_RAD) * 
                 COS( RADIANS(a."INSERT_NAME_RA") - INSERT_VALUE_RA_RAD) )
