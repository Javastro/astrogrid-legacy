...
public class JnlpServlet extends HttpServlet
{
  ...
  public void init( ServletConfig config ) throws ServletException
  {
    ...
    this.parseQueryString =
          config.getInitParameter( "parse.querystring" ).equalsIgnoreCase( "true" ) ? true : false;
  ...
  private StringBuffer getJnlpFromDisk( HttpServletRequest req, String match ) throws IOException
  {
