...
public class DSAServiceDesc extends ServiceDescription<DSAActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<DSAActivityConfigurationBean>> getActivityClass() {
		return DSAActivity.class;
	}
	 ...
	 */
	@Override
	public DSAActivityConfigurationBean getActivityConfiguration() {
		DSAActivityConfigurationBean bean = new DSAActivityConfigurationBean();
	...
	public List<String> getPath() {
		...
		return Arrays.asList("Astrogrid", "DSA");
	}
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("astroruntimeDSA");
	}
