...
public class DSAServiceProvider implements ServiceDescriptionProvider {
	...
	public void findServiceDescriptionsAsync(
		...
		// of dummy for-loop
		DSAServiceDesc dsaService = new DSAServiceDesc();
		dsaService.setDescription("Astrogrid DSA");
		results.add(dsaService);
		/*
		for (int i = 1; i <= 5; i++) {
