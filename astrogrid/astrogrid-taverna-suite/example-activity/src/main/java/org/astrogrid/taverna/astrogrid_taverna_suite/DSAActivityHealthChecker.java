 ...
 * 
 */
public class DSAActivityHealthChecker implements
		HealthChecker<DSAActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof DSAActivity;
	}
	...
	public VisitReport visit(DSAActivity activity, List<Object> ancestry) {
		DSAActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "DSA service OK", HealthCheck.NO_PROBLEM, subReports);
	}
