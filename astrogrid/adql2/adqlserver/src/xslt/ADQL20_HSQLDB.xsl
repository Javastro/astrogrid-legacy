...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
	...
	<!-- 
		...
		Current stylesheet was derived from HSQLDB-1.8.0.xsl
	 -->
	...
	<!--+
	    | HSQLDB has functions for bitwise OR, XOR and AND...
	    +-->
	<xsl:template match="*[ contains(@xsi:type, 'binaryExprType') ]">
		<xsl:choose>
           ...
           <!-- KEA: 
                - Added brackets around binary expressions to ensure correct precendence
	...
	<!--+
	    | HSQLDB has a CONCAT function to concatinate strings etc.
	    +-->
	...
	<!--+
	    | NOTE: Still need to check whether HSQLDB has a bitwise NOT operator
	    |       or a function, or nothing at all. May not be supported!
	    +-->
