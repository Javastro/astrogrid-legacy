 ...
 */
public class GeometryFunctionTypeImpl extends org.astrogrid.adql.beans.impl.FunctionTypeImpl implements org.astrogrid.adql.beans.GeometryFunctionType
{
    
    public GeometryFunctionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.astrogrid.adql.beans.GeometryFunctionNameType.Enum getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.astrogrid.adql.beans.GeometryFunctionNameType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.astrogrid.adql.beans.GeometryFunctionNameType xgetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.GeometryFunctionNameType target = null;
            target = (org.astrogrid.adql.beans.GeometryFunctionNameType)get_store().find_attribute_user(NAME$2);
            return target;
        }
    }
     ...
     */
    public void setName(org.astrogrid.adql.beans.GeometryFunctionNameType.Enum name)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetName(org.astrogrid.adql.beans.GeometryFunctionNameType name)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.astrogrid.adql.beans.GeometryFunctionNameType)get_store().add_attribute_user(NAME$2);
            }
            target.set(name);
        }
    }
