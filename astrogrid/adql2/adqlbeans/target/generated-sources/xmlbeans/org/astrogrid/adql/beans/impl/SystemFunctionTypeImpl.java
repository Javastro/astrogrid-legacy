 ...
 */
public class SystemFunctionTypeImpl extends org.astrogrid.adql.beans.impl.FunctionTypeImpl implements org.astrogrid.adql.beans.SystemFunctionType
{
    
    public SystemFunctionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.astrogrid.adql.beans.SystemFunctionNameType.Enum getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.astrogrid.adql.beans.SystemFunctionNameType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.astrogrid.adql.beans.SystemFunctionNameType xgetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.SystemFunctionNameType target = null;
            target = (org.astrogrid.adql.beans.SystemFunctionNameType)get_store().find_attribute_user(NAME$2);
            return target;
        }
    }
     ...
     */
    public void setName(org.astrogrid.adql.beans.SystemFunctionNameType.Enum name)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetName(org.astrogrid.adql.beans.SystemFunctionNameType name)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.astrogrid.adql.beans.SystemFunctionNameType)get_store().add_attribute_user(NAME$2);
            }
            target.set(name);
        }
    }
