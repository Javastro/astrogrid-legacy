...
<html>
<head>
<title>AstroGrid FileStore publish to Registry</title>
...
<p>
When setting up file store for the first time, you need to register your resources to a registry.  Fill in the 
