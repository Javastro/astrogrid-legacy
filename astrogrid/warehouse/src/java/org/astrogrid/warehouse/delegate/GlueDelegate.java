 ...
 * @author G. Rixon
 */
public class GlueDelegate implements WarehouseDelegateIfc
{
  /**
  ...
  /**
   * A stub standing as proxy for the service.
   */
  protected WarehouseServiceIfc binding;

  
  /**
   * Constructs a delegate based on a given service-endpoint.
   */
  public GlueDelegate(URL givenEndPoint) throws WarehouseException {
    try {
      this.endpoint = givenEndPoint;
      this.binding  = 
          (WarehouseServiceIfc) Registry.bind(this.endpoint.toExternalForm(),
                                              WarehouseServiceIfc.class);
    }
    catch (Exception e) {
      throw new WarehouseException("Couldn't bind to the " +
                                   "warehouse web-service", e);
    }
  }
 ...
 */
  ...
  */
  public static void main (String[] args) throws Exception {
    ...
    try {
      GlueDelegate delegate = new GlueDelegate(new URL(args[0]));
