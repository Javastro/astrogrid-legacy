...
public class DeleteHandlerTest extends BaseHandlerTest {
  /**
   * Constructor for DeleteHandlerTest.
   * @param name
   */
  public DeleteHandlerTest(String name) {
    super(name);
  }
  ...
  public void testExecute() throws Exception {
    ...
    // Setup store client... should have delete() called on it once only.
    context.setupGetStoreClient(storeClient);
    storeClient.setExpectedDeleteCalls(1);

    // Execute the handler.
    handler = new DeleteHandler(context);
