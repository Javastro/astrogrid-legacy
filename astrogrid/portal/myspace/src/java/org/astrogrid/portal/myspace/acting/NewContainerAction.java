...
public class NewContainerAction extends AbstractAction {
  ...
  public Map act(Redirector redirector, SourceResolver resolver, Map objectModel, String source, Parameters params) {
    ...
    try {
      ...
      renameResult = delegate.createContainer(userId, communityId, credential, newMySpaceName);
      
      request.setAttribute("myspace-new-container", "true");
      request.setAttribute("myspace-new-container-result", renameResult);
    }
    catch(Throwable t) {
      request.setAttribute("myspace-new-container", "false");
      request.setAttribute("myspace-new-container-error-message", t.getLocalizedMessage());
      sitemapParams = null;
