...
public class RenameAction extends AbstractAction {
  ...
  public Map act(Redirector redirector, SourceResolver resolver, Map objectModel, String source, Parameters params) {
    ...
    try {
      ...
      request.setAttribute("myspace-rename", "true");
      request.setAttribute("myspace-rename-result", renameResult);
    }
    catch(Throwable t) {
      request.setAttribute("myspace-rename", "false");
      request.setAttribute("myspace-rename-error-message", t.getLocalizedMessage());
      sitemapParams = null;
