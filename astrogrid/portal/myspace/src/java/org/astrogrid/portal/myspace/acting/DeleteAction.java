...
public class DeleteAction extends AbstractAction {
  ...
  public Map act(Redirector redirector, SourceResolver resolver, Map objectModel, String source, Parameters params) {
    ...
    try {
      ...
      renameResult = delegate.deleteDataHolding(userId, communityId, credential, oldMySpaceName);
      
      request.setAttribute("myspace-delete", "true");
      request.setAttribute("myspace-delete-result", renameResult);
    }
    catch(Throwable t) {
      request.setAttribute("myspace-delete", "false");
      request.setAttribute("myspace-delete-error-message", t.getLocalizedMessage());
      sitemapParams = null;
