...
<td bgcolor="#cccccc" id="tnut" onClick="openTag('tor');" align="center"> Tasks' Order</td>
</tr>
<tr valign="top">
<td colspan="7" height="350">
<div id="dgen" style="display: show">
Tips: On|Off
<form method="post" action="http://barbara.star.le.ac.uk/datoz-bin/profiler"
target="messagerie">
...
<form method="post" action="http://barbara.star.le.ac.uk/datoz-bin/profiler" target="messagerie">
...
<form method="post" name="shuffle" action="http://barbara.star.le.ac.uk/datoz-bin/profiler" target="messagerie">
