...
<xsl:variable name="RL">
  <xsl:choose>
    <xsl:when test="//*/profile/metadataBox = 'Left'">left</xsl:when>
...
<div id="hand" style="display: none"><xsl:value-of select="$RL"/></div>

<div height="100px" class="LargeHint" id="scratchArea" style="display: none">
test
</div>

<div height="100" width="100" class="metaHint" id="MDsummary" style="display: none;">
test
</div>
...
<img src="/astrogrid-portal/x.gif" id="underSelect" width="1" /><br />
<iframe name="metaframe"
src="/astrogrid-portal/bare//mount/datacenter/variables07.i07?tableID={$tableID}"
width="100%" height="400" onload="setRelHeight(this, 100)" border="0px" marginHeight="0px" marginWidth="0px"
style="border: solid 2px #ddffdd">
mu
</iframe>
...
style="border-left: solid 1px #69c; border-bottom: solid 1px #069;">
       ...
       -->
<img src="/astrogrid-portal/x.gif" width="1" id="tipMarker" /><br/>
...
width="100%" height="100" onload="tipsi(this, 360, 'tipsi', '{$RL}')" border="0px" marginHeight="0px" marginWidth="0px"
...
<xsl:variable name="displayFriendly">
  <xsl:choose>
...
<tr valign="top" ><td align="center" bgcolor="#009900"
onClick="makeADQL(this)" style="cursor: pointer" width="25">
...
<!--
  <xsl:if test="//*/profile/queryStyle != 'ADQL'">
<script language="javascript">
var po = document.getElementById("adqlSection");
if(po != null){
