...
<!--
<menu_Item   id="there" title="dataquery"
	type="submit"
	name="action"
	content="Save File"
	url="/astrogrid-portal/main/mount/datacenter/data-query.xml"
	target="_self"
	hover="Save this file (what else did you expect?)"
	onClicko="doThis()"
	>
</menu_Item>
<menu_Item   id="there" title="community"
	content="Community"
	url="http://www.yahoo.co.uk"
	target="_self"
	hover="Communite Issues"
	type="anchor"
	image="http://barbara.star.le.ac.uk/datoz/open24.gif"
	look="button"
	>
	<menu_Item   id="guten Tag" title="administration"
		content="Administration"
		url="/astrogrid-portal/main/mount/community/administration.html"
		target="_self"
		hover="Community administration aids"
		type="anchor"
		look="button"
		>
	</menu_Item>
	<menu_Item   id="guten Tag" title="manageCredentials"
		content="Manage Credentials"
		url="/astrogrid-portal/main/mount/community/credentials.html"
		target="_self"
		hover="Credential management centre"
		type="anchor"
		look="button"
		>
	</menu_Item>
</menu_Item>
<menu_Item   id="ho" title="registry"
	content="Registry"
	url="/astrogrid-portal/main/mount/registry/registry.html"
	target="_self"
	hover="Registry, the final frontier"
	helpURL="/astrogrid-portal/main/mount/registry/registry-help.xml"
	helpText="?"
	helpImage="http://barbara.star.le.ac.uk/datoz/quest.gif"
	helpImageWidtho="50"
	helpImageHeight="20"
	helpTarget="helpWindow"
	image="http://barbara.star.le.ac.uk/datoz/open24.gif"
	type="filler"
	look="image"
	width="100"
...
<menu_Item   id="there" title="cookbook"
	name="azione"
	content="CookBook"
	type="submit"
	uri="http://barbara.star.le.ac.uk:8080/cocoon/ag03/CookBook"
	url="javascript:document.main.submit()"
	target="_self"
	hover="Request the cookbook via POST"
	look="button"
	>
</menu_Item>
<menu_Item   id="there" title="FAQ"
	content="FAQ"
	url="http://barbara.star.le.ac.uk:8080/cocoon/ag03/FAQ"
	target="helpWindow"
	hover="Perhaps a list of good questions is a good idea?"
	look="button"
	type="anchor"
	leftIcono="http://barbara.star.le.ac.uk/datoz/quest.gif"
	rightIcono="http://barbara.star.le.ac.uk/datoz/quest.gif"
	>
</menu_Item>
-->
</experimentalMenu>
