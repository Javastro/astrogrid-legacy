...
domMenu_settings.setItem('global', new domMenu_Hash(
    'menuBarClass', 'agMenu_menuBar',
    'menuElementClass', 'agMenu_menuElement',
    'menuElementHoverClass', 'agMenu_menuElementHover',
    'menuElementActiveClass', 'agMenu_menuElementHover',
    'subMenuBarClass', 'agMenu_subMenuBar',
    'subMenuElementClass', 'agMenu_subMenuElement',
    'subMenuElementHoverClass', 'agMenu_subMenuElementHover',
    'subMenuElementActiveClass', 'agMenu_subMenuElementHover',
    'subMenuElementHeadingClass', 'agMenu_subMenuElementHeading',
    ...
    'closeMouseoutMenuDelay', 3000,
    'closeClickMenuDelay', -1,
    'closeMouseoutSubMenuDelay', 1000,
...
function domMenu_activate(in_containerId)
{
    ...
    for (var index = 1; index <= numSiblings; index++) {
        ...
        var iconImg = rootMenuTableCell.data.items['icon'];
        var iconTag = '';
        if (iconImg != null && iconImg.length > 0) {
          iconTag = '&nbsp;&nbsp;<img src="' + iconImg + '"/>&nbsp;&nbsp;'
        }
        rootElement.innerHTML = '<span>' + iconTag + rootMenuTableCell.data.items['contents'] + '</span>' + (rootMenuTableCell.data.hasItem('contentsHover') ? '<span style="display: none;">' + iconTag + rootMenuTableCell.data.items['contentsHover'] + '</span>' : '');
...
function domMenu_activateSubMenu(in_parentElement)
{
    ...
    for (var index = 1; index <= numSiblings; index++) {
        ...
        var iconImg = menuTableCell.data.items['icon'];
        var iconTag = '';
        if (iconImg != null && iconImg.length > 0) {
          iconTag = '<img src="' + iconImg + '"/>&nbsp;&nbsp;'
        }
        element.innerHTML = iconTag + menuTableCell.data.items['contents'];
