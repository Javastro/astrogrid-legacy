...
<xsl:stylesheet version="1.0"
  ...
  <center>
  <table width="310px" border="0" background="/astrogrid-portal/earthMoon.jpg">
  <tr valign="top"><td height="380">
  <span style="color: yellow; background-color: black; font-family: helvetica, arial; font-weight: bold">
  <xsl:value-of select="//*/userID" />, there are no jobs running for you at the
  moment
  </span>
  </td></tr>
  </table>
...
<tr>
<td><a target="_top" href="{link}" title="{inBrief}"><div class="agActionButton" ><xsl:value-of select="@name"/></div></a></td>
</tr>
</xsl:template>
