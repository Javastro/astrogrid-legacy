<?xml version="1.0"?>
<!--+
    | <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portal/explorer/site/xsl/Attic/explorer.xsl,v $</cvs:source>
    | <cvs:date>$Author: anoncvs $</cvs:date>
    | <cvs:author>$Date: 2003/12/16 12:45:24 $</cvs:author>
    | <cvs:version>$Revision: 1.1 $</cvs:version>
    | <cvs:log>
    | $Log: explorer.xsl,v $
    | Revision 1.1  2003/12/16 12:45:24  anoncvs
    | Add explorer files
    |
