      ...
      <xsl:template match="/results">
        <ag-div>
          ...
          <script type="text/javascript">
            window.name = "resourcesResultsFrame";
          </script>            
        ...
        <div class="summary" >
          ...
          <xsl:if test="count(vs:Table) &gt; 0">
            <xsl:element name="SPAN">                                
              <xsl:attribute name="title">&#10;table/column&#10;</xsl:attribute> 
              <xsl:attribute name="class">agActionButton</xsl:attribute> 
              <xsl:attribute name="onclick">toggle('table:<xsl:value-of select="vr:Identifier/vr:AuthorityID"/>/<xsl:value-of select="vr:Identifier/vr:ResourceKey"/>');</xsl:attribute>
              table/column
            </xsl:element>                    
          </xsl:if>
...
<!--          <span class="HEADING">Curation</span><br />  -->
          <span class="KEY">Title:</span> 
...
<!--          <span class="HEADING">Coverage</span><br />          -->
...
<!--          <span class="HEADING">Related resource</span><br />  -->
...
<!--          <span class="HEADING">Application definition</span><br />  -->
...
<!--          <span class="HEADING">Resource XML</span><br />   -->
