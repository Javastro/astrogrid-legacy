 ...
 <!--+
        ...
        <table border="2" cellpadding="0" cellspacing="0">
          ...
          <xsl:choose>
            <xsl:when test="./tool/@tool-name != 'null'">            
              ...
              <tr>
                <td align="center">Name:</td><td align="center">Indirect:</td><td align="center">Value:</td><td></td><td></td>
              </tr>                               
    ...
    <xsl:template name="parameter">
        <xsl:param name="direction"/>
            <form name="parameter_form" action="/astrogrid-portal/main/mount/workflow/agjobmanager.html" id="parameter_form">
                <tr>
                    <td><xsl:value-of select="@param-name"/></td>
                    <td><xsl:value-of select="@param-indirect"/></td>
<!--
                    <xsl:choose>
...
-->
                ...
                <input type="hidden" name="param_indirect"><xsl:attribute name="value">true</xsl:attribute></input>                                
            </form>
    </xsl:template>
