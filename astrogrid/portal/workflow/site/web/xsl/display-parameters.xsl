        ...
        <table border="2" cellpadding="0" cellspacing="0">
          ...
          <xsl:choose>
            <xsl:when test="./tool/@tool-name != 'null'">            
              <tr>
                <td colspan="4" style="color: blue; background-color: lightblue; text-align: center;">Input:</td>
              </tr>
              <tr>
                <td align="center">Name:</td><td align="center">Value:</td><td></td><td></td>
              </tr>                               
              ...
              <tr>
                <td colspan="4" style="color: blue; background-color: lightblue; text-align: center;">Output:</td>
              </tr>
              <tr>
                <td align="center">Name:</td><td align="center">Value:</td><td></td><td></td>
              </tr>                               
          ...
          <xsl:otherwise>
            <tr>
                <td colspan="4" >There is currently no tool associated with this step</td>
            </tr>    
          </xsl:otherwise>
        </xsl:choose>                        
      </table>
