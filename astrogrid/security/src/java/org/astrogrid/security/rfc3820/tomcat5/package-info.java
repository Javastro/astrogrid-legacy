/**
 * RFC3820-enabled implementation of SSL for Apache Tomcat 5.5.
 * <p>
 ...
 * {@link org.astrogrid.security.rfc3820.tomcat5.RFC3820Trustmanager} is a
 * suitable manager. The trust manager uses the
 * {@link org.astrogrid.security.rfc3820.tomcat5.CertificateChainValidator}
 * which in turn uses
 * {@link org.astrogrid.security.rfc3820.tomcat5.ProxyCertPathReviewer}.
 * <p>
 * The {@link org.astrogrid.security.rfc3820.tomcat5.JSSESocketFactory} is a
 ...
 * Tomcat 6.0.26.
 * <p>
 * All the classes that do logging use commons logging APIs. This makes them
 * compatible with Tomcat 5.5 but incompatible with Tomcat 6.0.
 */
