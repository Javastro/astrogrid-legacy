...
public class WorkspaceTest extends TestCase
{
   ...
   public static File setUpWorkspaceArea() throws IOException {
      ...
      String workspaceProperty = ConfigFactory.getCommonConfig().getString(Workspace.WORKSPACE_DIRECTORY_KEY, null);
      File dir = null;
    ...
    */
    protected void setUp() throws Exception{
        ...
        ConfigFactory.getCommonConfig().setProperty(Workspace.WORKSPACE_DIRECTORY_KEY, tmpDir.getAbsolutePath());
    }
