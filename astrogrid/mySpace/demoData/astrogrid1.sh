...
java -cp "WEB-INF/classes/:WEB-INF/lib/hsqldb-1.7.1.jar:WEB-INF/lib/log4j-1.2.4.jar" org.astrogrid.mySpace.mySpaceDemo.CreateMySpaceRegistry astrogrid-mySpace
