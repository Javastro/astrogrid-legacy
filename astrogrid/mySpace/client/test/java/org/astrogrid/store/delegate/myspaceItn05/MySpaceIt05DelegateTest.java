...
public class MySpaceIt05DelegateTest extends TestCase {
    ...
    public void testHeartBeat() throws Exception {
        try {
            MySpaceIt05Delegate middle =
                new MySpaceIt05Delegate(operator, mssUrl);
    ...
    public void testPutBytes() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "putBytes executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testPutString() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "putString executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testPutUrl() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "putUri executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testDelete() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "deleteFile executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testCopy() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "copyFile executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testMove() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "moveFile executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
    ...
    public void testChangeOwner() throws Exception {
        try {
            ...
            Assert.assertEquals(severity, StatusCodes.INFO);
            String message = status.getMessage();
            Assert.assertEquals(message, "changeOwner executed successfully.");
            middle.resetStatusList();
        } catch (Exception e) {
