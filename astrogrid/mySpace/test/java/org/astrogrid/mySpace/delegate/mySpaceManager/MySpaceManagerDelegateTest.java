...
public class MySpaceManagerDelegateTest extends TestCase
 ...
 */
   ...
   public MySpaceManagerDelegateTest (String name)
   {  super(name);
   }
...
//            System.out.println("firstUrl: " + firstUrl);
         ...
         {  if (fakeWebServices)
            ...
            {  mySpaceIndex = loop + 1;
               System.out.println("  MySpace system " + mySpaceIndex +
                 ", URL: " + (String)allMssUrls.elementAt(loop) );
            }
         }
      }
