 ...
 * </p>
 * <p>
 * <code>msStatus.addMessage("message text", MySpaceMessage.ERROR);</code>
 * </p>
 * <p>
 * or more conveniently these details can be passed using a constructor:
 * </p>
 * <p>
 * <code>MySpaceStatus msStatus = new MySpaceStatus("message text",
 *    MySpaceMessage.ERROR);</code>
 * </p>
 * <p>
 * In both cases the first argument is the message text, and the second is
 * the type of event being described, coded as an <code>int</code> as follows:
 * </p>
 * <ul>
 ...
 */
   ...
   public MySpaceStatus (String message, int type)
 ...
 */
   ...
   {  MySpaceMessage newMessage = new MySpaceMessage(message, type);
      ...
      if (type == MySpaceMessage.ERROR)
      {  successStatus = false;
      }
      else if (type == MySpaceMessage.WARN)
      {  warningStatus = true;
      }
   }
 ...
 */
   ...
   {  int numMessages = messages.size();
      ...
      {  MySpaceMessage currentMessage =
         ...
         int type = currentMessage.getType();

         if (type == MySpaceMessage.INFO)
         {  System.out.println("!(" + loop + ") Info:    " + message);
         }
         else if (type == MySpaceMessage.WARN)
         {  System.out.println("!(" + loop + ") Warning: " + message);
         }
         else if (type == MySpaceMessage.ERROR)
