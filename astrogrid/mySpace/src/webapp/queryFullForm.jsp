...
are shown using the `full-form', in which the file name is preceded by
its full container structure.
</p>


<form action="queryFull.jsp" method="POST">
<table>
  <tr>
  ...
  <tr>
    <td><INPUT TYPE="submit" NAME="button" VALUE="queryFull"></td>
    <td></td>
  </tr>
