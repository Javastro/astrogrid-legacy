...
<p>
This function will fail if a user with the specified user and community
identifiers already exists.  If you get an unexpected failure use the
full-form query function to check whether a user with the specified
