...
public abstract class BaseJPAController {
    ...
    protected static EntityManagerFactory  emf = Persistence.createEntityManagerFactory("net.ivoa_ivoa-objects_jar_1.1-SNAPSHOTPU");;
