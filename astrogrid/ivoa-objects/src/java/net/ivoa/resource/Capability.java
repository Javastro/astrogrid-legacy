/*
 * $Id: Capability.java,v 1.2 2011/09/13 13:43:30 pah Exp $
...
public class Capability {
    ...
    @OneToMany(targetEntity=CapabilityValidation.class,cascade=ALL, orphanRemoval = false)
    @JoinColumn(name="CAPABILITY_ID",referencedColumnName = "ID")
    @XmlElement(type = CapabilityValidation.class)
