/*
 * $Id: TableSchema.java,v 1.2 2011/09/13 13:43:27 pah Exp $
...
@javax.persistence.Table(name="TableSchema")
public class TableSchema {
    ...
    @JoinColumn(name="SCHEMA_IDENTIFIER",referencedColumnName = "ID")
