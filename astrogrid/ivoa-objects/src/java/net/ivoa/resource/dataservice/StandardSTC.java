/*
 * $Id: StandardSTC.java,v 1.2 2011/09/13 13:43:27 pah Exp $
...
import net.ivoa.xml.stc.stc_v1_30_prov.StcDescriptionType;
...
public class StandardSTC
    extends Resource
{
//TODO need to make this an xml column
    @Transient
    @XmlElement(required = true, type = StcDescriptionType.class)
    protected List<StcDescriptionType> stcDefinitions;
    
    @XmlTransient
    protected String stcDescription;
