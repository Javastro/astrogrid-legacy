...
public class Content {
    ...
    protected List<JAXBElement<String>> subject;
     ...
     * 
     */
    public List<JAXBElement<String>> getSubject() {
        if (subject == null) {
            subject = new ArrayList<JAXBElement<String>>();
        }
        return this.subject;
    }
	...
	getSubject().add(new JAXBElement<String>(new QName("subject"),String.class, string));
    }
