/*
 * $Id: TimeIntervalType.java,v 1.2 2011/09/13 13:43:22 pah Exp $
    ...
    extends CoordIntervalType
{
    ...
    @XmlElementRef(name = "StartTime", namespace = "http://www.ivoa.net/xml/STC/stc-v1.30.xsd", type = JAXBElement.class)
    protected JAXBElement<AstronTimeType> startTime;
    @XmlElementRef(name = "StopTime", namespace = "http://www.ivoa.net/xml/STC/stc-v1.30.xsd", type = JAXBElement.class)
    ...
    public void setStartTime(JAXBElement<AstronTimeType> value) {
        this.startTime = ((JAXBElement<AstronTimeType> ) value);
    }
    ...
    public void setStopTime(JAXBElement<AstronTimeType> value) {
        this.stopTime = ((JAXBElement<AstronTimeType> ) value);
    }
