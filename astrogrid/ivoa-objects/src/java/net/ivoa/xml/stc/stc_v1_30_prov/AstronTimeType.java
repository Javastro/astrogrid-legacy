/*
 * $Id: AstronTimeType.java,v 1.2 2011/09/13 13:43:24 pah Exp $
...
public class AstronTimeType {
    ...
    @XmlElementRef(name = "Timescale", namespace = "http://www.ivoa.net/xml/STC/stc-v1.30.xsd", type = JAXBElement.class)
    ...
    public void setTimescale(JAXBElement<TimeScaleType> value) {
        this.timescale = ((JAXBElement<TimeScaleType> ) value);
    }
    ...
    public void setAbsoluteTime(JAXBElement<?> value) {
        this.absoluteTime = ((JAXBElement<?> ) value);
    }
