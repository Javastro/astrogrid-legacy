/*$Id: SiapDispatcher.java,v 1.3 2005/04/25 12:13:54 clq2 Exp $
...
/** Dispatcher that will execute in-process SIAP searches.
 * @author Noel Winstanley nw@jb.man.ac.uk 07-Feb-2005
 *
 */
public class SiapDispatcher extends AbstractInProcessDispatcher implements      ComponentDescriptor {

    /** Construct a new InProcessConeSearchDispatcher
     * 
     */
    public SiapDispatcher(CEAComponentManager cea) {
        super(cea);
    }
    ...
    public String getDescription() {
        return "Dispatcher for SIAP queries";
    }
...
/* 
$Log: SiapDispatcher.java,v $
Revision 1.3  2005/04/25 12:13:54  clq2
jes-nww-776-again

Revision 1.2.20.1  2005/04/11 13:56:22  nw
organized imports
