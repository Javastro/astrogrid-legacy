...
public class JES extends org.astrogrid.Configurator {
  ...
  private static final String SUBSYSTEM_ACRONYM = "JES";

  /** Configuration file for this component. */
  private static final String CONFIG_FILENAME = "ASTROGRID_jesconfig.xml";
  ...
  private static JES singletonJES = new JES();
  ...
  protected String getSubsystemAcronym() {
    return SUBSYSTEM_ACRONYM;
  }
  /**
