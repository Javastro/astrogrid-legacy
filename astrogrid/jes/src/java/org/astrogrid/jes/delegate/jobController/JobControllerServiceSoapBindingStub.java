...
public class JobControllerServiceSoapBindingStub extends org.apache.axis.client.Stub implements org.astrogrid.jes.delegate.jobController.JobController {
    ...
    static {
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "jobListXML"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
    ...
    public java.lang.String submitJob(java.lang.String jobXML) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("jobController.astrogrid.org", "submitJob"));
    ...
    public java.lang.String readJobList(java.lang.String jobListXML) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("jobController.astrogrid.org", "readJobList"));

        setRequestHeaders(_call);
        setAttachments(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {jobListXML});
