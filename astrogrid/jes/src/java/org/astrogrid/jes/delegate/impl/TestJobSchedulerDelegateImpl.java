/*$Id: TestJobSchedulerDelegateImpl.java,v 1.2 2004/02/09 11:41:44 nw Exp $
...
public class TestJobSchedulerDelegateImpl extends JobSchedulerDelegate {
    ...
    /**
     * @see org.astrogrid.jes.delegate.jobScheduler.JobSchedulerDelegate#scheduleJob(org.astrogrid.jes.beans.v1.Job)
     */
    public void scheduleJob(Job j) throws JesDelegateException {
        log.info("Scheduling job " + j.toString());
    }
}
