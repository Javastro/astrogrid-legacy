    ...
    <div class="h3">
        ...
        <h3>
          <a name="Configuration, Testing and Web Services">Configuration, Testing and Web Services</a>
        </h3>
    ...
    <a href="configuration.jsp">
     Check and modify MySpace configuration
   </a>
    ...
    <a href="TestServlet?suite=org.astrogrid.mySpace.installationTests.DeploymentTests">
     Run installation tests
      ...
      to ensure that all config files and database files are located
