...
public class AllTests {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("Test for org.astrogrid.jes.job");
        //$JUnit-BEGIN$
        suite.addTest(new TestSuite(JobExceptionTest.class));
        suite.addTest(new TestSuite(JobStepTest.class));
        suite.addTest(new TestSuite(ParameterTest.class));
        suite.addTest(new TestSuite(ToolTest.class));
        //$JUnit-END$
        return suite;
    }
}
