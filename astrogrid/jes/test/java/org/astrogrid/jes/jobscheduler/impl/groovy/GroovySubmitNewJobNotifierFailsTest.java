/*$Id: GroovySubmitNewJobNotifierFailsTest.java,v 1.2 2004/07/30 15:42:34 nw Exp $
...
import org.astrogrid.jes.jobscheduler.impl.AbstractTestForSubmitNewJobNotifierFails;

/** test what happens when the notifier fails in the scripted scheduler
 * @author Noel Winstanley nw@jb.man.ac.uk 13-May-2004
 *
 */
public class GroovySubmitNewJobNotifierFailsTest extends AbstractTestForSubmitNewJobNotifierFails {
