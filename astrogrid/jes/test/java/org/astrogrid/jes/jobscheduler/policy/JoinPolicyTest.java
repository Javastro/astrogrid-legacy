/*$Id: JoinPolicyTest.java,v 1.1 2004/03/18 10:56:47 nw Exp $
 ...
 *
 */
public class JoinPolicyTest extends AbstractTestForPolicy {
    /**
     * Constructor for JoinPolicyTest.
     * @param arg0
     */
    public JoinPolicyTest(String arg0) {
        super(arg0);
    }
    /*
    ...
    protected AbstractPolicy createPolicy() {
        return new JoinPolicy();
    }
}


/* 
$Log: JoinPolicyTest.java,v $
