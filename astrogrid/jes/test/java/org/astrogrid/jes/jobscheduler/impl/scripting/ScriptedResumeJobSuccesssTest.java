/*$Id: ScriptedResumeJobSuccesssTest.java,v 1.1 2004/07/09 09:32:12 nw Exp $
...
import org.astrogrid.jes.jobscheduler.impl.ResumeJobSuccessTest;
 ...
 *
 */
public class ScriptedResumeJobSuccesssTest extends ResumeJobSuccessTest {
    /** Construct a new ScriptedResumerJobSuccesssTest
     * @param arg0
     */
    public ScriptedResumeJobSuccesssTest(String arg0) {
        super(arg0);
    }
/**
...
protected AbstractJobFactoryImpl createJobFactory() {
    ...
    /**
     * @see org.astrogrid.jes.jobscheduler.impl.ResumeJobSuccessTest#getKeyFor(org.astrogrid.workflow.beans.v1.Workflow, org.astrogrid.workflow.beans.v1.Step)
     */
...
/* 
$Log: ScriptedResumeJobSuccesssTest.java,v $
