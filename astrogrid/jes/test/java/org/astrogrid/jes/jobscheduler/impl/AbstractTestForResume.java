/*$Id: AbstractTestForResume.java,v 1.2 2004/07/30 15:42:34 nw Exp $
 ...
 *
 */ 
public abstract class AbstractTestForResume extends AbstractTestForSchedulerImpl {
    /** Construct a new ResumeJobSuccessTest
     * @param arg0
     */
    public AbstractTestForResume(String arg0) {
        super(arg0);
    }
    /**
    ...
    protected void performTest(JobURN urn) throws Exception {  
        ...
        assertNotNull(stepId); //@todo fail here - as no ids have been assigned.
...
/* 
$Log: AbstractTestForResume.java,v $
