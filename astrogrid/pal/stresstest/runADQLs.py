...
# ROE
ivorn = "agtest.roe.ac.uk/mysql-first-5-0/ceaApplication"
#ivorn = "agtest.roe.ac.uk/mysql-first-5-5/ceaApplication"
# DAVE
#ivorn = "org.astrogrid.demo/first-catalogue/ceaApplication"
# DEV NETWORK
#ivorn = "dev2.star.le.ac.uk/mysql-first-roe/ceaApplication"

# The required results format
#format = "VOTABLE-BINARY"
...
# ROE
destFolder = "ivo://agtest.roe.ac.uk/KonaAndrews#test_folder"
dest = "ivo://agtest.roe.ac.uk/KonaAndrews#test_folder/new_fileSUBS_NUM.vot"
# DAVE
#destFolder = "ivo://org.astrogrid.demo/frog#test_folder"
#dest = "ivo://org.astrogrid.demo/frog#test_folder/new_fileSUBS_NUM.vot"
# DEV NW
#destFolder = "ivo://org.astrogrid.test1.community1/KonaAndrews#test_folder"
#dest = "ivo://org.astrogrid.test1.community1/KonaAndrews#test_folder/new_fileSUBS_NUM.vot"
...
if (checkonly == 0) :
	...
	#template = template.replace("SUBS_FORMAT",format)
