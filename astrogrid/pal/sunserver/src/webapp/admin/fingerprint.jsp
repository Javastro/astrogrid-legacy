...
<%
   Class pluginClass =  ConfigFactory.getCommonConfig().getClass(org.astrogrid.dataservice.queriers.QuerierPluginFactory.QUERIER_PLUGIN_KEY, null);
   ...
   if (pluginClass == null)
   {
     ...
     try {
        out.println(" - found on classpath");
         ...
         if (pluginClass.getName().equals(JdbcPlugin.class.getName())) {
