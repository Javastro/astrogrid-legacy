/*
 * $Id: AdqlXml074Parser.java,v 1.1 2005/02/17 18:37:34 mch Exp $
 *
...
//      }
   ...
   /** Parses a function */
   public Function parseFunction(Element arg) {
      Element[] args = DomHelper.getChildrenByTagName(arg, "Arg");
      Expression[] exps = new Expression[args.length];
      for (int i = 0; i < exps.length; i++) {
         exps[i] = parseNumExpression(args[i]);
      }
      Function func = new Function(arg.getAttribute("Name"),exps);
      return func;
   }
