/*
 * $Id: MonitoredOutputStream.java,v 1.2 2006/09/26 15:34:42 clq2 Exp $
 *
...
public class MonitoredOutputStream extends ByteCountingOutputStream {
   ...
   public MonitoredOutputStream(OutputStream out, int updateInterval, StreamProgressListener aListener) {
      super(out);
