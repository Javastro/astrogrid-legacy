...
<a href="configure.jsp">This page</a> describes in detail how to configure
...
run the <a href="../self-test.jsp">installation tests</a> and some cone <a href="../coneForm.jsp">queries</a>
 on it, as it contains a simple SQL database by default. <i><b>Note that some of the self tests will fail until
 you have completed the setup process.</i></b> The errors they report should give you some indication of anything
 you have missed.
<p/>
...
<p>The <a href="configure.jsp">config pages</a> describe how to make these.  Once this
