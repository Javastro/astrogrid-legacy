...
//               "INSERT INTO Plates VALUES ("+i+", "+(100+i*20)+", "+(100-i*20)+", "+sqlDateFormat.format(new java.sql.Date(todayTime-i*1000))+")"
   ...
   *** empty log message ***
   ...
   Revision 1.8.6.5  2005/01/24 12:14:30  mch
   Fixes to VizieR proxy and resource stuff

   Revision 1.8.6.4  2004/12/10 12:37:13  mch
   Cone searches to look in metadata, lots of metadata interpreterrs

   Revision 1.8.6.3  2004/12/08 23:23:37  mch
   Made SqlWriter and AdqlWriter implement QueryVisitor

   Revision 1.8.6.2  2004/12/08 18:36:40  mch
   Added Vizier, rationalised SqlWriters etc, separated out TableResults from QueryResults

   Revision 1.8.6.1  2004/12/03 11:56:43  mch
