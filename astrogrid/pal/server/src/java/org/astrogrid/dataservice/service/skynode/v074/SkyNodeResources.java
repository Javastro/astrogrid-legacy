/*$Id: SkyNodeResources.java,v 1.1 2005/03/08 18:05:57 mch Exp $
 ...
 */
public class SkyNodeResources extends VoResourceSupport implements VoResourcePlugin {
   
   /**
    * Returns ServiceType for Skynode SOAP interface
    */
