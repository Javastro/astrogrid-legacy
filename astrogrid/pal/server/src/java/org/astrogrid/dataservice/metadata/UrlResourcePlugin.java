/*
 * $Id: UrlResourcePlugin.java,v 1.1 2005/02/17 18:37:34 mch Exp $
 *
...
public class UrlResourcePlugin extends VoResourceSupport implements VoResourcePlugin
{
   ...
   public void checkResource(Element resource, URLConnection connection) throws MetadataException {
      ...
      ensureSummary(resource);
      ensureCuration(resource);
   }
