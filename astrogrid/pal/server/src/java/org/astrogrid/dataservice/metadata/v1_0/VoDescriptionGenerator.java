...
/**
 * Assembles the various v1.0 VoResource elements provided by the plugins, 
...
public class VoDescriptionGenerator extends VoDescriptionGeneratorBase {
   ...
   public String makeVoDescription() throws IOException, MetadataException {
    ...
    // Set up v1.0 resources
      pluginList.add((Object)"org.astrogrid.tableserver.metadata.v1_0.VoDataService");
