/*$Id: AxisDataService05QueryTest.java,v 1.1 2005/02/17 18:37:35 mch Exp $
...
import org.astrogrid.datacenter.query.adql.Adql074Writer;
...
public class AxisDataService05QueryTest extends ServerTestCase {
   ...
   public AxisDataService05QueryTest(String arg0) {
    ...
    public void testDoOneShotAdql() throws Exception {
       ...
       Query query1 = SimpleQueryMaker.makeConeQuery(20,-30,6);
...
Revision 1.8.12.2  2004/12/08 18:36:40  mch
Added Vizier, rationalised SqlWriters etc, separated out TableResults from QueryResults

Revision 1.8.12.1  2004/11/29 23:32:33  mch
Added FROM
