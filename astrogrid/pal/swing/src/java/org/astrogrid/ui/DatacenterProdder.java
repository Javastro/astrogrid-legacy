/* $Id: DatacenterProdder.java,v 1.1 2005/02/17 18:37:35 mch Exp $
 *
...
import org.astrogrid.query.AdqlQueryMaker;
import org.astrogrid.query.Query;
import org.astrogrid.returns.ReturnTable;
...
//      setUser(new IvoAccount(new Ivorn("ivo://test.astrogrid.org/avodemo")));
   ...
   public void kickOffSearch()  {
      ...
      try {
         ...
         query.setResultsDef(new ReturnTable(TargetMaker.makeIndicator(resultsLoc), QuerySearcher.VOTABLE));
 ...
 *** empty log message ***
 ...
 Revision 1.11.8.1  2004/11/02 21:51:54  mch
