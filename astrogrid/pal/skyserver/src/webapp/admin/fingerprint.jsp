     ...
     try {
        ...
        out.println(" - found on classpath");
         ...
         if (plugin.getName().equals(JdbcPlugin.class.getName())) {
            ...
            String sqlMaker = SimpleConfig.getProperty(org.astrogrid.dataservice.queriers.sql.JdbcPlugin.SQL_TRANSLATOR, null) ;
            String jdbcUrl = SimpleConfig.getProperty(org.astrogrid.dataservice.queriers.sql.JdbcConnections.JDBC_URL_KEY, null) ;
