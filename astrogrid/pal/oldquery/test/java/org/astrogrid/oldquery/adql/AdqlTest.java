/*
 * $Id: AdqlTest.java,v 1.2 2006/06/15 16:50:09 clq2 Exp $
 *
...
/**
 * Round-trip tests for OLD query model - can we accept ADQL queries, parse them & produce matching ADQL?
 *
 */
...
public class AdqlTest extends XMLTestCase   {
   ...
   */
   public void roundParse(Document fileAdqlDom) throws Exception {
      ...
      OldQuery query = AdqlXml074Parser.makeQuery(fileAdqlElement);
      String writtenAdql = Adql074Writer.makeAdql(query);
