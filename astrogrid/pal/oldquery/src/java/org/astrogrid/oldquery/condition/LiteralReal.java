/*
 * $Id: LiteralReal.java,v 1.2 2006/06/15 16:50:09 clq2 Exp $
 *
...
/**
 * A LiteralReal is a constant real value with associated units
...
public class LiteralReal extends LiteralNumber {
   ...
   public LiteralReal(String givenValue) {
     value = Double.parseDouble(givenValue);
   }

   public LiteralReal(String givenValue, String unitEq) {
      value = Double.parseDouble(givenValue);
      units = new Units(unitEq);
   }

   public LiteralReal(double givenValue) {
      value = givenValue;
   }

   public LiteralReal(double givenValue, String unitEq) {
      value = givenValue;
      units = new Units(unitEq);
   }

   public String toString() {
      return "[Real] "+value+" "+units;
   }
