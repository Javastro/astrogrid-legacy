/*
 * $Id: AdqlXml074Parser.java,v 1.2 2006/06/15 16:50:09 clq2 Exp $
 *
 ...
 *
 * @author M Hill
 * @deprecated This class is no longer used in constructing the DSA internal 
 * query model, is incomplete in its handling of ADQL, and is no longer being 
 * maintained.
 */
...
public class AdqlXml074Parser  {
   ...
   public static OldQuery makeQuery(Element adql) {
    ...
    * and returns a Query model */
   public static OldQuery makeQuery(String adql) throws ParserConfigurationException, SAXException, IOException {
      return makeQuery(DomHelper.newDocument(adql).getDocumentElement());
   }
   
   /** Static convenience method, creates an instance, parses the given ADQL object model
    * and returns a Query model */
   public static OldQuery makeQuery(InputStream adqlIn) throws ParserConfigurationException, SAXException, IOException {
   ...
   public OldQuery parseSelect(Element select) {
