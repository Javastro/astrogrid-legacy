...
#
# Check if settings have been overridden
...
export ASTROGRID_EXTERNAL=http://${ASTROGRID_HOST}:${ASTROGRID_PORT}

for SETTING in JAVA_HOME ASTROGRID_HOME ASTROGRID_USER ASTROGRID_PASS ASTROGRID_HOST ASTROGRID_PORT ASTROGRID_AUTH ASTROGRID_EMAIL ASTROGRID_ADMIN ASTROGRID_INTERNAL ASTROGRID_EXTERNAL
do
...
echo "  ASTROGRID_INTERNAL  : ${ASTROGRID_INTERNAL:?"undefined"}"
echo "  ASTROGRID_EXTERNAL  : ${ASTROGRID_EXTERNAL:?"undefined"}"
