/*
 * $Id: FailbackTest.java,v 1.1 2005/03/21 14:05:47 mch Exp $
 *
...
public class FailbackTest extends TestCase
{
   ...
   public void testTypes() throws IOException
   {
    ...
    public void testFileFinder() throws IOException {
      ...
      try {
         ConfigReader.resolveFilename("${badlyformed/thing");
         fail("Did not throw exception for bad int");
      }
      ...
      URL url = ConfigReader.resolveFilename("${FailbackTest.path}test.properties");
