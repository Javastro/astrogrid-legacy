...
public class FactoryTest extends TestCase {
   ...
   public void testPropertyMaker() throws IOException {
      ...
      ConfigReader configA = ConfigFactory.getConfig("Arthur");
      log.debug("Got Arthur "+configA);
      assertNotNull(configA);
      
      ConfigReader configB = ConfigFactory.getConfig("Bernard");
      ...
      ConfigReader configC = ConfigFactory.getConfig("Arthur");
