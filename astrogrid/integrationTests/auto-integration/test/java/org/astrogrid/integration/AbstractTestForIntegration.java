/*$Id: AbstractTestForIntegration.java,v 1.16 2004/11/19 10:27:29 clq2 Exp $
...
//        checkMemory("post: " + this.getClass().getName());
    ...
    /** IVORN representing user. initialized in {@link #setUp()}  to ivo://{@link #COMMUNITY}/{@link #USERNAME} */
   protected Ivorn userIvorn;

   /** IVORN representing myspace initialized in {@link #setUp()}  to ivo://{@link #MYSPACE}*/
   ...
   /** test username - something amphibious */
    ...
    /** test community. Defaults to <tt>org.astrogrid.localhost</tt>, can be overridden by setting key <tt>org.astrogrid.registry.authorityid</tt> 
     * @todo I don't think these keys are mixed up, but not brave enough to swap them myself. Kevin?*/
    public static final String COMMUNITY = SimpleConfig.getProperty("org.astrogrid.registry.authorityid", "org.astrogrid.localhost");

    /** test authorityid. Defaults to <tt>org.astrogrid.localhost</tt>, can be overridden by setting key <tt>org.astrogrid.community.ident</tt>
     * @todo I don't think these keys are mixed up, but not brave enough to swap them myself. Kevin? */    
    public static final String AUTHORITYID = SimpleConfig.getProperty("org.astrogrid.community.ident", "org.astrogrid.localhost");
    /** registry key for myspace */
    public static final String MYSPACE = COMMUNITY + "/myspace";
    /** registry key for test datacenter application */
    public static final String TESTDSA = COMMUNITY + "/testdsa";
    /** registry key for test commandline application */
    public static final String TESTAPP = COMMUNITY + "/testapp";
    /** registry key for another test commandline application */
    public static final String TESTAPP2 = COMMUNITY + "/testap2"; //note it isn't double 'p'
    /** registry key for a test java application */
    public static final String HELLO_WORLD = COMMUNITY + "/helloWorld";
    /** registry key for another test java application */
    public static final String HELLO_YOU = COMMUNITY + "/helloYou";
    /** registry key for another test java application */
    public static final String SUM = COMMUNITY + "/sum";
    //New Http-based apps
    /** registry key for a test http application */
...
Revision 1.15.22.1  2004/11/18 10:52:01  nw
