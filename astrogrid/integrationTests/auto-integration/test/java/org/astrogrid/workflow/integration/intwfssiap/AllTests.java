...
public class AllTests {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(
                "Test for org.astrogrid.workflow.integration.intwfssiap");
        //$JUnit-BEGIN$
        suite.addTestSuite(SiapImageFetchUsingScriptTest.class);
        suite.addTestSuite(SiapImageFetchUsingToolTest.class);
        //$JUnit-END$
        return suite;
    }
}
