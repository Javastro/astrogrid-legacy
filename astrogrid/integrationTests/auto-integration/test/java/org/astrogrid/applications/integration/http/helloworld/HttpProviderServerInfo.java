...
public class HttpProviderServerInfo implements ServerInfo {
    ...
    public String getApplicationName() {
        return AbstractTestForIntegration.HTTP_HELLO_WORLD;
    }
    /**
    ...
    public void populateIndirectTool(Tool tool, String inputURI, String outputURI) {
        ParameterValue pval = (ParameterValue)tool.findXPathValue("output/parameter[name='message']");
