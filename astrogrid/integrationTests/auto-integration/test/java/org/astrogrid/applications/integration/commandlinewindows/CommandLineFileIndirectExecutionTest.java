/*
 * $Id: CommandLineFileIndirectExecutionTest.java,v 1.2 2005/05/17 23:07:54 jdt Exp $
 * 
...
protected void checkResults(ResultListType results) throws Exception {
    ...
    assertTrue("expected message not found in execution output\n+" + out.toString(),out.toString().indexOf(CommandLineProviderServerInfo.TEST_OUTPUT) != -1);           
  }
