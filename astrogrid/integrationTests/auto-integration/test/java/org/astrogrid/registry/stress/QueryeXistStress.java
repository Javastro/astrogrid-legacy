...
public class QueryeXistStress extends AbstractTestForIntegration {
  ...
  public void testQuery1() throws Exception {
    ...
    String xql = declarations + " //vr:Resource[vr:Identifier/vr:AuthorityID='CDS' and vr:Identifier/vr:ResourceKey='VizieR/J/A+A/281/817/table3a']";
  ...
  public void testQuery2() throws Exception {
      ...
      String numberOfResourcesReturned = "25";
      String declarations = SimpleConfig.getProperty("declare.namespace.0_9");
      String xql = declarations + " //vr:Resource[vr:Identifier/vr:AuthorityID='CDS' and vr:Identifier/vr:ResourceKey='VizieR/J/A+A/281/817/table4a']";
      String query = "<query xmlns=\"http://exist.sourceforge.net/NS/exist\"" +
         " start=\"1\" max=\"" + numberOfResourcesReturned + "\">" +
         "<text><![CDATA[" + xql + "]]></text></query>";
      queryDoc = DomHelper.newDocument(query);
  ...
  public void testQuery3() throws Exception {
      ...
      String numberOfResourcesReturned = "25";
      String declarations = SimpleConfig.getProperty("declare.namespace.0_9");
      String xql = declarations + " //vr:Resource[vr:Identifier/vr:AuthorityID='org.astrogrid.leicester' and vr:Identifier/vr:ResourceKey='filestore-two']";
      String query = "<query xmlns=\"http://exist.sourceforge.net/NS/exist\"" +
         " start=\"1\" max=\"" + numberOfResourcesReturned + "\">" +
         "<text><![CDATA[" + xql + "]]></text></query>";
      queryDoc = DomHelper.newDocument(query);
