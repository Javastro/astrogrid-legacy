/* $Id: SimpleMySpaceTest.java,v 1.6 2004/02/14 19:10:39 jdt Exp $
...
public class SimpleMySpaceTest extends TestCase {
    ...
    */ 
    public void testAddDeleteUser() {
        ...
        try {
        	ok1 =
        		createUser(userId, communityId, mySpaceEndPoint);
	 ...
	 * 
	 */
	private boolean deleteUser(String userID, String communityID, String endPoint) throws Exception {
...
return ok2;
	 ...
	 * 
	 */
	private boolean createUser(String userID, String communityID, String endPoint) throws Exception {
		assert endPoint != null;
        MySpaceClient client = null;
        try {
            client = MySpaceDelegateFactory.createDelegate(endPoint);
