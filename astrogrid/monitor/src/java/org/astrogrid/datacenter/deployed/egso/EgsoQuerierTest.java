/*$Id: EgsoQuerierTest.java,v 1.1 2004/11/03 05:20:50 mch Exp $
...
public class EgsoQuerierTest extends TestCase {
   ...
   protected void askAdqlFromFile(String queryFile) throws Exception {
      ...
      Querier q = Querier.makeQuerier(Account.ANONYMOUS, AdqlQueryMaker.makeQuery(is, TargetMaker.makeIndicator(sw), ReturnTable.VOTABLE));
