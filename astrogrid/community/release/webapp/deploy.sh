...
#
# <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/community/release/webapp/Attic/deploy.sh,v $</cvs:source>
...
${JDK_HOME:?"undefined"}/bin/java -classpath ${BUILD_CLASSPATH:?"undefined"} -Dant.home=${ANT_HOME:?"undefined"} org.apache.tools.ant.Main -buildfile deploy.xml $1 $2
