/*
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/community/codereview/Sept11/policy/server/Attic/CommunityConfigImpl.java,v $</cvs:source>
...
public class CommunityConfigImpl
	...
	public void init()
      ...
      System.setProperty("org.astrogrid.auth.server.mapping","c:\\mapping.xml");
      System.setProperty(DATABASE_CONFIG_PROPERTY,"file://c:\\database.xml");
      System.setProperty(DATABASE_NAME_PROPERTY,"policy");

      System.out.println("okay just did the setproperties");
		//
