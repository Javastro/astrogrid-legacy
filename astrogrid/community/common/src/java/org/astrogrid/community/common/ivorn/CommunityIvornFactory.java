...
public class CommunityIvornFactory
	 ...
	 *
	 */
	public static String createIdent(String ident, String account)
		{
	 ...
	 *
	 */
	public static String createIdent(String ident, String account, String path)
		{
	 ...
	 *
	 */
	public static String createIdent(String ident, String account, String path, String fragment)
		{
	 ...
	 *
	 */
	public static String createIdent(String ident, String account, String path, String query, String fragment)
		{
