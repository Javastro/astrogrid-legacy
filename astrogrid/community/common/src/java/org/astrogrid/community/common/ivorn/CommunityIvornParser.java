...
public class CommunityIvornParser
	 ...
	 *
	 */
	public void parseCommunityIdent()
		{
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
	...
	public Ivorn getAccountIvorn()
		...
		{
		if ((null != this.getCommunityIdent()) && (null != this.getAccountIdent()))
			{
			return CommunityIvornFactory.createIvorn(
				this.getCommunityIdent(),
				this.getAccountIdent()
				) ;
			}
		else {
			return null ;
