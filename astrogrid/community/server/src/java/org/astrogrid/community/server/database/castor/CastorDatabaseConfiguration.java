...
public class CastorDatabaseConfiguration
     ...
     *
    public CastorDatabaseConfiguration(String name, String xml)
        throws IOException, MappingException
        {
        this(name, xml, null) ;
        }
     ...
     *
     */
    public CastorDatabaseConfiguration(String name, String xml, String sql)
        throws IOException, MappingException
        {
    ...
    public void setDatabaseConfigResource(String resource)
        ...
        if (DEBUG_FLAG) System.out.println("") ;
        if (DEBUG_FLAG) System.out.println("----\"----") ;
        if (DEBUG_FLAG) System.out.println("CastorDatabaseConfiguration:setDatabaseConfigResource()") ;
    ...
    public void setDatabaseConfigUrl(URL url)
        ...
        if (DEBUG_FLAG) System.out.println("") ;
        if (DEBUG_FLAG) System.out.println("----\"----") ;
        if (DEBUG_FLAG) System.out.println("CastorDatabaseConfiguration:setDatabaseConfigUrl()") ;
    ...
    protected void loadDatabaseConfig()
        ...
        if (DEBUG_FLAG) System.out.println("") ;
        if (DEBUG_FLAG) System.out.println("----\"----") ;
        if (DEBUG_FLAG) System.out.println("CastorDatabaseConfiguration:loadDatabaseConfig()") ;
        if (DEBUG_FLAG) System.out.println("  URL : '" + this.databaseConfigUrl + "'") ;
        //
    ...
    protected void loadDatabaseEngine()
        ...
        if (DEBUG_FLAG) System.out.println("") ;
        if (DEBUG_FLAG) System.out.println("----\"----") ;
        if (DEBUG_FLAG) System.out.println("CastorDatabaseConfiguration:loadDatabaseEngine()") ;
...
//
     ...
     * At the moment, it relies on having a CastorDatabaseTestData table in the database.
