...
<vor:Resource xsi:type="vr:Service"  updated="2004-11-20T15:34:22Z" status="active">
 ...
 <curation>
  <publisher>Policy Manager Community</publisher>
  <contact>
   <name><%= request.getParameter("ContactName") %></name>
   <email><%= request.getParameter("ContactEmail") %></email>
  </contact>
 ...
 <content>
  ...
  <description>Policy Manager</description>
  <referenceURL>http://www.astrogrid.org</referenceURL>
  <type>BasicData</type>
  <relationship>
    ...
    <interface xsi:type="vs:WebService">
		<accessURL use="full"><%=polManager%></accessURL>
    </interface> 
</vor:Resource>
<vor:Resource xsi:type="vr:Service"  updated="2004-11-20T15:34:22Z" status="active">
 <title>Policy Service Community</title>
 <identifier>ivo://<%=communityid%>/org.astrogrid.community.common.policy.service.PolicyService</identifier>
 <curation>
  <publisher>Policy Service Community</publisher>
  <contact>
   <name><%= request.getParameter("ContactName") %></name>
   <email><%= request.getParameter("ContactEmail") %></email>
  </contact>
 ...
 <content>
  ...
  <type>BasicData</type>
    ...
    <interface xsi:type="vs:WebService">
		<accessURL use="full"><%=polService%></accessURL>
    </interface> 
</vor:Resource>
<vor:Resource xsi:type="vr:Service"  updated="2004-11-20T15:34:22Z" status="active">
 <title>Security Manager</title>
 <identifier>ivo://<%=communityid%>/org.astrogrid.community.common.security.manager.SecurityManager</identifier>
 <curation>
  <publisher>Security Manager</publisher>
  <contact>
   <name><%= request.getParameter("ContactName") %></name>
   <email><%= request.getParameter("ContactEmail") %></email>
  </contact>
 ...
 <content>
  ...
  <type>BasicData</type>
    ...
    <interface xsi:type="vs:WebService">
		<accessURL use="full"><%=secManager%></accessURL>
    </interface> 
</vor:Resource>
<vor:Resource xsi:type="vr:Service"  updated="2004-11-20T15:34:22Z" status="active">
 <title>Security Service</title>
 <identifier>ivo://<%=communityid%>/org.astrogrid.community.common.security.service.SecurityService</identifier>
 <curation>
  <publisher>Security Service</publisher>
  <contact>
   <name><%= request.getParameter("ContactName") %></name>
   <email><%= request.getParameter("ContactEmail") %></email>
  </contact>
 ...
 <content>
  ...
  <type>BasicData</type>
    ...
    <interface xsi:type="vs:WebService">
		<accessURL use="full"><%=secService%></accessURL>
    </interface> 
</vor:Resource>
</vor:VOResources>