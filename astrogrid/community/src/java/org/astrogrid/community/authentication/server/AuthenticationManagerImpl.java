/*
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/community/src/java/org/astrogrid/community/authentication/server/Attic/AuthenticationManagerImpl.java,v $</cvs:source>
            ...
            if(foundToken) {
               ...
               System.out.println("----") ;
                ...
                try {
                   database.commit();
                   database.close();
                }catch(TransactionNotInProgressException tn) {
               ...
               String accountCommName = Community.getCommunityNameFromString(account);
               String localCommName = Community.getCommunityName();
               String targetCommName = Community.getCommunityNameFromString(target);
               String commUrl = null;
               ...
               if(localCommName.equals(accountCommName)) {
                  ...
                  CommunityData commData = adminDelegate.getCommunity(accountCommName);
