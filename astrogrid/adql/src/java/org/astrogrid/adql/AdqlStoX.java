/* Generated By: AdqlStoX.jjt,v 1.30 2006/10/28 22&JJTree&JavaCC: Do not edit this line. AdqlStoX.java */
...
public class AdqlStoX/*@bgen(jjtree)*/implements AdqlStoXTreeConstants, AdqlStoXConstants {/*@bgen(jjtree)*/
  protected JJTAdqlStoXState jjtree = new JJTAdqlStoXState();
    ...
    private void exitTrace( String entry ) {
        ...
        public class ColumnReferenceHolder {

            private SelectionItemType crType ;

                private ColumnReferenceHolder() {}

                public ColumnReferenceHolder( ColumnReferenceType columnReferenceType ) {
                        crType = columnReferenceType;
                }

                public ColumnReferenceHolder( AliasSelectionItemType aliasSelectionItemType ) {
                        crType = aliasSelectionItemType ;
                }

                public boolean isColumnReference() {
                        return ( crType instanceof ColumnReferenceType ) ;
                }

                public boolean isAliasedExpression() {
                        return ( crType instanceof AliasSelectionItemType ) ;
                }

                public ColumnReferenceType getColumnReference() {
                        if( isColumnReference() )
                                return (ColumnReferenceType)crType ;
                        return null ;
                }

                public AliasSelectionItemType getAliasedExpression() {
                        if( isAliasedExpression() )
                                return (AliasSelectionItemType)crType ;
                        return null ;
                }
        }
 ...
 *     See footnote (2) on enforcing qualified column names
 *     and the effect on aliased expressions. 
 * bnf-end
 *
 */
