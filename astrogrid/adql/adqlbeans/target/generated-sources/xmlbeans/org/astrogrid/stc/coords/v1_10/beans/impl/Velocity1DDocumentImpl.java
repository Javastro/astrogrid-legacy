 ...
 */
public class Velocity1DDocumentImpl extends org.astrogrid.stc.coords.v1_10.beans.impl.VelocityDocumentImpl implements org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument
{
    
    public Velocity1DDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName VELOCITY1D$0 = 
     ...
     */
    public org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D getVelocity1D()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D target = null;
            target = (org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D)get_store().find_element_user(VELOCITY1D$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setVelocity1D(org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D velocity1D)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D)get_store().add_element_user(VELOCITY1D$0);
            }
            target.set(velocity1D);
        }
    }
     ...
     */
    public org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D addNewVelocity1D()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class Velocity1DImpl extends org.astrogrid.stc.coords.v1_10.beans.impl.ScalarCoordinateTypeImpl implements org.astrogrid.stc.coords.v1_10.beans.Velocity1DDocument.Velocity1D
    {
        
        public Velocity1DImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
