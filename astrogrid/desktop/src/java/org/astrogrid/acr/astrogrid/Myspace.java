/*$Id: Myspace.java,v 1.5 2005/08/05 11:46:55 nw Exp $
...
// node based creation
     ...
     * @throws NodeNotFoundFault if the parent does not exist
     * @throws ServiceException if error occurs calling the service
     * @throws SecurityException if the user is not permitted to create folders here
     * @throws InvalidArgumentException if a child file or folder with this name already exists, or the parent is not a folder.
     * 
     */
    ...
    public URI createChildFile(URI parentIvorn, String name) throws NotFoundException,
            ServiceException, SecurityException, InvalidArgumentException;
...
URI rename(URI srcIvorn, String newName) throws NotFoundException, SecurityException, ServiceException, InvalidArgumentException;
   ...
   * @throws InvalidArgumentException if the resource to move to is not a folder, or a resource with name =newName= already exists in this folder  
   * @throws SecurityException if the user is not permitted to move this resource
   * @throws ServiceException if an error occurs calling the service.
   */
   URI move(URI srcIvorn, URI newParentIvorn, String newName) throws NotFoundException, InvalidArgumentException, SecurityException, ServiceException;
 ...
 * @throws InvalidArgumentException if the resource is not a file - folders can't be relocated.
 * @throws ServiceException if an error occurs calling the service
 * @throws SecurityException if the user is not permitted to relocate this resource
 */
void changeStore(URI srcIvorn, URI storeIvorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
...
URI copy(URI srcIvorn, URI newParentIvorn, String newName) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
    ...
    String read(URI ivorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
     ...
     * @throws SecurityException if the user is not permitted to access this resource
     */
    void write(URI ivorn, String content) throws InvalidArgumentException, ServiceException, SecurityException;
     ...
     * @throws SecurityException if the user is not permitted to access this resource
     */
    byte[] readBinary(URI ivorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
     ...
     * @throws SecurityException if the user is not permitted to access this resource
     */
    void writeBinary(URI ivorn,byte[] content) throws InvalidArgumentException, ServiceException, SecurityException;
     ...
     */
    URL getReadContentURL(URI ivorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
     ...
     */
    URL getWriteContentURL(URI ivorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
     ...
     * @throws SecurityException if the user is not permitted to read the contents of this resource
     */
    void copyContentToURL(URI ivorn, URL destination) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
     ...
     * @throws NotFoundException if the myspace resource does not exist
     * @throws InvalidArgumentException if the sre is not readable
     * @throws ServiceException if an error occurs while calling the service
     * @throws SecurityException if the user is not permitted to write the contents of this resource
     */
    void copyURLToContent(URL src, URI ivorn) throws NotFoundException, InvalidArgumentException, ServiceException, SecurityException;
