/*$Id: CheckJDICBrowserPresent.java,v 1.1 2005/06/23 09:08:26 nw Exp $
...
public class CheckJDICBrowserPresent implements Check {
    ...
    public boolean check() {
        try {
            ...
            logger.info("JDIC extensions not present - cannot start embedded system browser",e);
        } catch (UnsatisfiedLinkError e) {
            logger.info("JDIC classes present, but binary libraries are not - cannot start embedded system browser",e);
        }
        return false;
    }
