/*$Id: RmiLiteRmiServerImpl.java,v 1.1 2005/08/05 11:46:55 nw Exp $
    ...
    public void newModuleRegistered(NewModuleEvent e) {
        ...
        for (Iterator i = module.getDescriptor().componentIterator(); i.hasNext(); ) {
            ...
            if (cd.getProperty(RmiLiteACR.LISTENER_INTERFACES_KEY) != null) {
                ...
                StringTokenizer tok = new StringTokenizer(cd.getProperty(RmiLiteACR.LISTENER_INTERFACES_KEY));
