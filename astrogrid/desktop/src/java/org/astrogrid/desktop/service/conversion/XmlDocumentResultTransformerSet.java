/*$Id: XmlDocumentResultTransformerSet.java,v 1.1 2005/02/22 01:10:31 nw Exp $
...
import org.astrogrid.desktop.service.conversion.transformers.IDTransformer;

/**
 * @author Noel Winstanley nw@jb.man.ac.uk 21-Feb-2005
 *@todo add stlylesheet to render xml into html.
 */
public class XmlDocumentResultTransformerSet extends StringResultTransformerSet {

    /** Construct a new XmlDocumentResultTransformerSet
     * 
     */
    protected XmlDocumentResultTransformerSet() {
        super();
    ...
    private static ResultTransformerSet theInstance = new XmlDocumentResultTransformerSet();     
