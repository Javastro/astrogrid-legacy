#!/usr/bin/env python
#tests for the stap componen - querying a voevent service.
...
class StapVoevent(unittest.TestCase):
    ...
    def constructQuery(self):
        ...
        end = DateTime('20000101T12:00:00')
...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(StapVoevent)
