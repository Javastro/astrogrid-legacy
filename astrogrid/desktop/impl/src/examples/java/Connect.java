...
/*$Id: Connect.java,v 1.1 2006/01/13 15:44:22 nw Exp $
...
//         use this service.. 
        ...
        System.out.println(registry.getResourceInformation(u)); // returns a struct of data.
        // registry.getRecord(u) returns a org.w3c.dom.Document..

        u = new URI("ivo://uk.ac.le.star/filemanager");
        System.out.println(registry.resolveIdentifier(u)); // returns a java.net.URL
