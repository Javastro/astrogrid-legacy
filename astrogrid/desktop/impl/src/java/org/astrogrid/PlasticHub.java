/*$Id: PlasticHub.java,v 1.4 2006/10/11 10:34:34 nw Exp $
...
public class PlasticHub {
    ...
    public static void main(String[] args) {
        ...
        SplashWindow.splash(PlasticHub.class.getResource("plastic-splash.gif"));
        SplashWindow.invokeMain("org.astrogrid.PlasticHub1", args);
