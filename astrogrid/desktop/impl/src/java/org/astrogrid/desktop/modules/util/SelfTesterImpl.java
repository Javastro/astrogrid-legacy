...
/** Displays the results of the selftest.
 * @author Noel.Winstanley@manchester.ac.uk
 * @since Oct 11, 200711:52:00 AM
 */
public class SelfTesterImpl extends UIComponentImpl implements SelfTester,TestListener, ActionListener{
    /**
     ...
     */
    public SelfTesterImpl(UIContext context,SchedulerInternal scheduler,List contribution,int delay) throws HeadlessException {
        super(context);
        ...
        addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                getContext().unregisterWindow(SelfTesterImpl.this);
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        new BackgroundWorker(this,"Running self tests") {
            ...
            protected Object construct() throws Exception {
                ...
                result.addListener(SelfTesterImpl.this); // listener methods will be called on the BG thread, but changes appear in ui on EDT thread
                suite.run(result);
                return result;
            }
