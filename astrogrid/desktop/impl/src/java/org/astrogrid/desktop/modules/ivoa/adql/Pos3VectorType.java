...
public class Pos3VectorType  extends org.astrogrid.desktop.modules.ivoa.adql.PosCoordType  implements java.io.Serializable {
    private org.astrogrid.desktop.modules.ivoa.adql.Coord3ValueType coordValue;
    private org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordError;
    private org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordResolution;
    private org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordSize;
    private org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordPixsize;
    private org.astrogrid.desktop.modules.ivoa.adql.AngleUnitType pos_ang_unit;  // attribute

    public Pos3VectorType() {
    }

    public org.astrogrid.desktop.modules.ivoa.adql.Coord3ValueType getCoordValue() {
        return coordValue;
    }

    public void setCoordValue(org.astrogrid.desktop.modules.ivoa.adql.Coord3ValueType coordValue) {
        this.coordValue = coordValue;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType getCoordError() {
        return coordError;
    }

    public void setCoordError(org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordError) {
        this.coordError = coordError;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType getCoordResolution() {
        return coordResolution;
    }

    public void setCoordResolution(org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordResolution) {
        this.coordResolution = coordResolution;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType getCoordSize() {
        return coordSize;
    }

    public void setCoordSize(org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordSize) {
        this.coordSize = coordSize;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType getCoordPixsize() {
        return coordPixsize;
    }

    public void setCoordPixsize(org.astrogrid.desktop.modules.ivoa.adql.Coord3SizeType coordPixsize) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Pos3VectorType.class);
