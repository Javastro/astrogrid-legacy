...
public class OrderExpressionType  implements java.io.Serializable {
    private org.astrogrid.desktop.modules.ivoa.adql.OrderType[] item;

    public OrderExpressionType() {
    }

    public org.astrogrid.desktop.modules.ivoa.adql.OrderType[] getItem() {
        return item;
    }

    public void setItem(org.astrogrid.desktop.modules.ivoa.adql.OrderType[] item) {
        this.item = item;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.OrderType getItem(int i) {
        return item[i];
    }

    public void setItem(int i, org.astrogrid.desktop.modules.ivoa.adql.OrderType value) {
        this.item[i] = value;
    }
