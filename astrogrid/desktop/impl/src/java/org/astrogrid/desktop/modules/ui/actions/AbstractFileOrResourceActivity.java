...
public  abstract class AbstractFileOrResourceActivity extends AbstractActivity{
	...
	public void selected(Transferable r) {
		...
		if (r.isDataFlavorSupported(VoDataFlavour.LOCAL_RESOURCE)) {
			...
			manyResourcesSelected((Resource[])r.getTransferData(VoDataFlavour.LOCAL_RESOURCE_ARRAY));
		} else if (r.isDataFlavorSupported(VoDataFlavour.RESOURCE_ARRAY)) {
			manyResourcesSelected((Resource[])r.getTransferData(VoDataFlavour.RESOURCE_ARRAY));
