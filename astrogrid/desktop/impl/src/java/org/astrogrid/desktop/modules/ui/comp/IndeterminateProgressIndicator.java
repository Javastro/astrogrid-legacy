...
public class IndeterminateProgressIndicator  extends JComponent{
    ...
    /** handy subclass that integrates the progress indicator with a button.
     * when button is enabled, progress starts, and stops when progress stops.
    */
