...
public class PolygonType  extends org.astrogrid.desktop.modules.ivoa.adql.ShapeType  implements java.io.Serializable {
    private org.astrogrid.desktop.modules.ivoa.adql.VertexType[] vertex;

    public PolygonType() {
    }

    public org.astrogrid.desktop.modules.ivoa.adql.VertexType[] getVertex() {
        return vertex;
    }

    public void setVertex(org.astrogrid.desktop.modules.ivoa.adql.VertexType[] vertex) {
        this.vertex = vertex;
    }

    public org.astrogrid.desktop.modules.ivoa.adql.VertexType getVertex(int i) {
        return vertex[i];
    }

    public void setVertex(int i, org.astrogrid.desktop.modules.ivoa.adql.VertexType value) {
        this.vertex[i] = value;
    }
