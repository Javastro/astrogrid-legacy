...
import org.astrogrid.desktop.modules.dialogs.registry.ResourceTable;
...
import org.astrogrid.desktop.modules.ui.voexplorer.ResourceFoldersList;
...
// drop target code.
	...
	public void dragEnter(DropTargetDragEvent dtde) {
		...
		if (CollectionUtils.exists(dtde.getCurrentDataFlavorsAsList(),dragPredicate)) {
			...
			if (component instanceof JComponent) {// most likely.
				((JComponent)component).setBorder(ResourceFoldersList.DROP_BORDER);
			}
		}
	}
	...
	public void dragExit(DropTargetEvent dte) {
		...
		if (component instanceof JComponent) {// most likely.
			((JComponent)component).setBorder(ResourceFoldersList.EMPTY_BORDER);
		}
	}
