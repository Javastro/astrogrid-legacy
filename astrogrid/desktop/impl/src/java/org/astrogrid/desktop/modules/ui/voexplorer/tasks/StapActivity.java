 ...
 */
public class StapActivity extends AbstractResourceActivity {
/**
 * 
 */
public StapActivity(TaskInvoker t) {
	CSH.setHelpIDString(this, "resourceTask.stap");		
	this.t = t;
	setText("Time series search");
	setIcon(IconHelper.loadIcon("search16.png"));	
	setToolTipText("Perform a time-series search on the selected service");
}
...
public void someSelected(List l) {
	...
	protected boolean invokable(Resource r) {
		return r instanceof Service && r.getType().indexOf("SimpleTimeAccess") != -1;
	}
