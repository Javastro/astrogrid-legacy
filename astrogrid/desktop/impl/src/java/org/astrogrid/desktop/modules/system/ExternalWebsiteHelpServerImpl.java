/*$Id: ExternalWebsiteHelpServerImpl.java,v 1.1 2007/01/09 16:24:35 nw Exp $
...
/** Implementation of the help server that displays help in system browser. Help is at 
 * external URLs.
 * @author Noel Winstanley nw@jb.man.ac.uk 17-Jun-2005
 *
 */
public class ExternalWebsiteHelpServerImpl implements  HelpServerInternal{
    /**
     * Commons Logger for this class
     */
    private static final Log logger = LogFactory.getLog(ExternalWebsiteHelpServerImpl.class);

    /** Construct a new HelpServerImpl
     * 
     */
        
    public ExternalWebsiteHelpServerImpl(List helpsets) {
    	super();
...
/* 
$Log: ExternalWebsiteHelpServerImpl.java,v $
Revision 1.1  2007/01/09 16:24:35  nw
start of alternative javahelp impleemntatio (unfinished)
