...
public class TabularMetadataViewer extends JTable implements ResourceViewer{
	public TabularMetadataViewer() {
		...
		FormLayout layout = new FormLayout("right:pref, 3dlu,max(100dlu;pref),3dlu:grow" // cols
				,"p,2dlu,max(10dlu;pref),3dlu, p,2dlu,max(10dlu;pref),3dlu,fill:100dlu:grow" // rows
				);
		...
		final JScrollPane scrollPane1 = new JScrollPane(this,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
