# name = 'Bulk catalog search'
# tooltip = 'Generate a python workfow that \nperforms a series of catalog searches \mfor a list of positions on the selected resources'
# condition = {it.type.contains('Cone')   ||  it.type.contains('TabularSkyService')}
...
parser.add_option('-s','--service',action="append", metavar="ID",
                  help="URL/registryID of a service to query - repeat for multiple services (defaults: %s)" % '\\n'.join(cones))
