...
/** Interceptor that logs warning messages when calling methods that have been deprecated.
 * @author Noel Winstanley
 * @since May 18, 200611:51:33 PM
 */
public class DeprecationInterceptorFactory implements ServiceInterceptorFactory {
	/**
	...
	public DeprecationInterceptorFactory(ClassFactory fac) {
		super();
		this._factory = fac;
	}
	/**
    ...
    protected void addServiceMethodImplementation(ClassFab classFab, MethodSignature sig)
    {
        ...
        builder.begin();
        builder.addln("_log.warn(\"This method is deprecated: \" + _interfaceName + \"." + sig.getName() + "\");");
