 ...
 *
 */
public class WorkflowBuilderLauncherImpl extends UIComponent implements org.astrogrid.acr.ui.WorkflowBuilder,  UserLoginListener {
	        ...
	        public void actionPerformed(ActionEvent e) {
	        	try{
	                (new BackgroundOperation("Loading Workflow") {
	                    protected Object construct() throws Exception {	        		
		        	    URI u = chooser.chooseResource("Load workflow",true);
		                if (u != null ) {
    ...
    private JButton clearButton, searchButton, findButton = null;
