...
/** cribbed from AbstractFileObject in commons.vfs source - but with 
 * less implementation restrictions (AbstractFileObject required AbstractFileName)
 * 
 * unsure whethe this covers all the bases in all cases - a stop-gap measure at best.
 * @author Noel.Winstanley@manchester.ac.uk
 * @since Jul 23, 20077:34:20 PM
 */
public abstract class MoreAbstractFileObject implements FileObject {
     ...
     * @version $Revision: 1.2 $ $Date: 2007/07/26 18:21:45 $
     ...
     */
        ...
        protected MoreAbstractFileObject(final FileName name,
        ...
        public int delete(final FileSelector selector) throws FileSystemException
        {
            ...
            {
                final FileObject file = FileObjectUtils.getAbstractFileObject((FileObject) files.get(i));
                // file.attach();
                ...
                // Delete the file
                boolean deleted = doDeleteSelf(file);
                if (deleted)
                {
                    nuofDeleted++;
                }
        ...
        /** implement to delete files - original implementaito was AbstractFileObject.deleteSelf*/
        protected abstract boolean doDeleteSelf(FileObject file) ;
        ...
        /**
         * Abstractimplementation calls
         * eturn new DefaultFileContent(this, getFileContentInfoFactory());
         * but, again relied on AsbtractFileObject
         * Create a FileContent implementation
         */
        protected abstract FileContent doCreateFileContent() throws FileSystemException;
    ...
    // Get the raw output stream
        ...
        /** implement to allow types to be updated 
         * @param name2
         * @param type2
         */
        protected void doSetType(FileName name2, FileType type2) throws FileSystemException {
        }
