...
public class HistoryUnitTest extends TestCase {
	...
	public void testEvents() throws Exception {
		MockControl m = MockControl.createControl(HistoryListener.class);
		HistoryListener l = (HistoryListener)m.getMock();
		Object o = "a";
		m.setDefaultMatcher(MockControl.EQUALS_MATCHER); 
		...
		m.verify(); // verifies that the listener was only called once.
	}
