 ...
 */
public class ConeRpcTransportTest extends ConeRmiTransportTest implements Cone{
	 protected void setUp() throws Exception {
	    ...
	    public static Test suite() {
	        return new ARTestSetup(new TestSuite(ConeRpcTransportTest.class));
	    }
		...
		public URL addOption(URL arg0, String arg1, String arg2) throws InvalidArgumentException {
			...
			v.add(arg2.toString());
			try {
				String s =  (String)client.execute("ivoa.cone.addOption",v);
				return new URL(s);
			} catch (Exception e) {
		...
		public URL constructQuery(URI arg0, double arg1, double arg2, double arg3) throws InvalidArgumentException, NotFoundException {
			...
			try {
				String s =  (String)client.execute("ivoa.cone.constructQuery",v);
				return new URL(s);
			} catch (Exception x) {
		...
		public String getRegistryQuery() {
			...
			v.clear();
			try {
				return  (String)client.execute("ivoa.cone.getRegistryQuery",v);
			} catch (Exception e) {
				fail(e.getMessage());
		...
		public Map[] execute(URL arg0) throws ServiceException {
			...
			v.add(arg0.toString());
			try {
				List l = (List)client.execute("ivoa.cone.execute",v);
		...
		public Document executeVotable(URL arg0) throws ServiceException {		
			...
			v.add(arg0.toString());
			try {
				String s =  (String)client.execute("ivoa.cone.executeVotable",v);
		...
		public void executeAndSave(URL arg0, URI arg1) throws SecurityException, ServiceException, InvalidArgumentException {
			...
			v.add(arg1.toString());
			try {
				client.execute("ivoa.cone.executeAndSave",v);
		...
		public String getRegistryAdqlQuery() {
			...
			v.clear();
			try {
				return  (String)client.execute("ivoa.cone.getRegistryAdqlQuery",v);
			} catch (Exception e) {
				fail(e.getMessage());
				throw new RuntimeException("never reached");
			}
		...
		public String getRegistryXQuery() {
			...
			v.clear();
			try {
				return  (String)client.execute("ivoa.cone.getRegistryXQuery",v);
			} catch (Exception e) {
				fail(e.getMessage());
				throw new RuntimeException("never reached");
			}
