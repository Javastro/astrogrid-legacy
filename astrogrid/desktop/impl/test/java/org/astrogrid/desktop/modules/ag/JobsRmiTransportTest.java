/*$Id: JobsRmiTransportTest.java,v 1.1 2007/01/09 16:12:18 nw Exp $
 ...
 *
 */
public class JobsRmiTransportTest extends JobsSystemTest {
    ...
    public static Test suite() {
        return new ARTestSetup(new TestSuite(JobsRmiTransportTest.class),true); // login.
    }    
}
