 ...
 */
public class CoordinateRpcTransportTest extends CoordinateSystemTest implements Coordinate {
	  protected void setUp() throws Exception {
	    ...
	    public static Test suite() {
	        return new ARTestSetup(new TestSuite(CoordinateRpcTransportTest.class));
	    }
