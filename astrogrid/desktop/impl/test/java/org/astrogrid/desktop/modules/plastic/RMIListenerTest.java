...
public class RMIListenerTest extends PresetupHub {
	...
	public void testSend() {
		...
		URI listenerId = hub.registerRMI("listener1", CommonMessageConstants.EMPTY, listener);
	...
	public void testSelectiveListeners() {
		...
		assertEquals(result1,"listener1"+test+message1+"2");
	...
	public void testSendToSubset() {
		...
		URI listenerId1 = hub.registerRMI("listener1", CommonMessageConstants.EMPTY, listener1);
		PlasticListener listener2 = new TestListener("listener2");
		URI listenerId2 = hub.registerRMI("listener2", CommonMessageConstants.EMPTY, listener2);		
...
;
	...
	public void testSendAsynch() {
		...
		URI listenerId = hub.registerRMI("listener2", CommonMessageConstants.EMPTY, listener);
	...
	public void testSendToSubsetAsynch() {
		...
		hub.registerRMI("listener1", CommonMessageConstants.EMPTY, listener1);
	...
	public void testGetRegUnregMessage() {
		TestListener2 listener1 = new TestListener2();
		TestListener2 listener2 = new TestListener2();
		URI id1 = hub.registerRMI("listener1", CommonMessageConstants.EMPTY, listener1);
		URI id2 = hub.registerRMI("listener2", CommonMessageConstants.EMPTY, listener2);
