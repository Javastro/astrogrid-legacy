...
#
# After completng each step, re-run the script to see your progress.

# *TIP - run with 'python -i tutorial.py' to keep the interpreter open
# after the script has completed - this makes it easy to inspect variable values
# and experiment
