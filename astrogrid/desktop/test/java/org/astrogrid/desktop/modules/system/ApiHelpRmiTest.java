/*$Id: ApiHelpRmiTest.java,v 1.1 2005/08/05 11:46:55 nw Exp $
 ...
 *
 */
public class ApiHelpRmiTest extends ApiHelpTest {
    protected ACR getACR() throws Exception{
        return (new Finder()).find();
    }
    public static Test suite() {
        return new ACRTestSetup(new TestSuite(ApiHelpRmiTest.class));
    }
}


/* 
$Log: ApiHelpRmiTest.java,v $
