/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/upload/Attic/UploadResponseParser.java,v $</cvs:source>
 * <cvs:date>$Author: dave $</cvs:date>
 * <cvs:author>$Date: 2003/06/22 04:03:41 $</cvs:author>
 * <cvs:version>$Revision: 1.1 $</cvs:version>
 *
 * <cvs:log>
 * $Log: UploadResponseParser.java,v $
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.upload ;
...
/**
 * An XML parser to handle an upload response.
 *
 */
public class UploadResponseParser
	extends SAXDocumentHandler
	implements UploadResultHandler
	{
	/**
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("UploadResponseParser.parse(String)") ;
			System.out.println("----") ;
