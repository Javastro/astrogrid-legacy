/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/export/Attic/ExportResultParser.java,v $</cvs:source>
 * <cvs:date>$Author: dave $</cvs:date>
 * <cvs:author>$Date: 2003/06/29 02:45:22 $</cvs:author>
 * <cvs:version>$Revision: 1.1 $</cvs:version>
 *
 * <cvs:log>
 * $Log: ExportResultParser.java,v $
...
/**
 * An XML parser to handle an export response.
 *
 */
public class ExportResultParser
	 ...
	 *
	 */
	private ExportResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public ExportResultParser(ExportResultHandler handler)
		{
		//
