/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/copy/junit/Attic/JUnitTestCase.java,v $</cvs:source>
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.copy.junit ;
...
public class JUnitTestCase
	 ...
	 *
	 */
	protected static String COPY_NAME = "/clq/serv2/FROG008" ;
	...
	public void testCopyRequest()
		...
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
		if (DEBUG_FLAG) System.out.println("testCopyRequest") ;
		...
		CopyRequestBuilder request = new CopyRequestBuilder(FILE_NAME, COPY_NAME) ;
		if (DEBUG_FLAG)
			{
			System.out.println("----") ;
		...
		String response = service.copyDataHolder(request.toString()) ;
