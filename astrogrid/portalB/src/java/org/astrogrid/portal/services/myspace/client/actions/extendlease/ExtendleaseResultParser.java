 ...
 *
 */
public class ExtendleaseResultParser
	extends SAXElementHandler
	implements ExtendleaseResultHandler
	{
	/**
	 ...
	 *
	 */
	private ExtendleaseResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public ExtendleaseResultParser(ExtendleaseResultHandler handler)
		{
		//
	...
	protected void startElement()
		...
		if (DEBUG_FLAG) System.out.println("Start of results ExtendLease") ;
		}
	...
	protected void closeElement()
		throws SAXException
		{
		if (DEBUG_FLAG) System.out.println("Close of results ExtendLease") ;
		if (DEBUG_FLAG) System.out.println("----") ;
		}
