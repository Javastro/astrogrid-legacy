 ...
 *
 */
public class CreateUserResponseParser
	 ...
	 *
	 */
	public CreateUserResponseParser()
		{
		//
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("CreateUserResponseParser.parse(String)") ;
			System.out.println("----") ;
	...
	public void init()
		{
		//
		// Add a CreateUserResultParser.
		addElementHandler(
			new CreateUserResultParser(this)
			) ;
		}
