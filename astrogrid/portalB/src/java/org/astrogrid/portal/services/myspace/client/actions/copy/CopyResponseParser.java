 ...
 *
 */
public class CopyResponseParser
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("CopyResponseParser.parse(String)") ;
			System.out.println("----") ;
	...
	public void init()
		{
		//
		// Add a CopyResultParser.
		addElementHandler(
			new CopyResultParser(this)
			) ;
		}
