/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/create/junit/Attic/JUnitTestCase.java,v $</cvs:source>
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.create.junit ;
...
public class JUnitTestCase
	 ...
	 *
	 */
	protected static String FILE_PATH = "/clq/serv2" ;

	/**
	 * Test container name.
	 *
	 */
	protected static String FILE_NAME = "FROGS" ;
	...
	public void testCreateRequest()
		...
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
		if (DEBUG_FLAG) System.out.println("testCreateRequest") ;
		...
		CreateRequestBuilder request = new CreateRequestBuilder(FILE_NAME, FILE_PATH) ;
		if (DEBUG_FLAG)
			{
			System.out.println("----") ;
		...
		String response = service.createContainer(request.toString()) ;
