/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/copy/Attic/CopyResultParser.java,v $</cvs:source>
 * <cvs:date>$Author: dave $</cvs:date>
 * <cvs:author>$Date: 2003/06/22 04:03:41 $</cvs:author>
 * <cvs:version>$Revision: 1.1 $</cvs:version>
 *
 * <cvs:log>
 * $Log: CopyResultParser.java,v $
...
/**
 * An XML parser to handle a copy response.
 *
 */
public class CopyResultParser
	extends SAXElementHandler
	implements CopyResultHandler
	{
	/**
	 ...
	 *
	 */
	private CopyResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public CopyResultParser(CopyResultHandler handler)
		{
		//
