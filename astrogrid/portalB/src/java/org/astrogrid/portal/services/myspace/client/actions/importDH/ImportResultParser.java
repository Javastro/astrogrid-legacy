 ...
 *
 */
public class ImportResultParser
	 ...
	 *
	 */
	private ImportResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public ImportResultParser(ImportResultHandler handler)
		{
		//
	...
	protected void startElement()
		...
		if (DEBUG_FLAG) System.out.println("Start of results Import") ;
		}
	...
	protected void closeElement()
		throws SAXException
		{
		if (DEBUG_FLAG) System.out.println("Close of results Import") ;
		if (DEBUG_FLAG) System.out.println("----") ;
		}
