/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/delete/junit/Attic/JUnitTestCase.java,v $</cvs:source>
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.delete.junit ;
...
public class JUnitTestCase
	...
	public void testDeleteRequest()
		...
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
		if (DEBUG_FLAG) System.out.println("testDeleteRequest") ;
		...
		//
		// Create a request.
		DeleteRequestBuilder request = new DeleteRequestBuilder(FILE_NAME) ;
		if (DEBUG_FLAG)
			{
			System.out.println("----") ;
		...
		String response = service.deleteDataHolder(request.toString()) ;
