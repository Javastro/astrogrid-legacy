/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/move/Attic/MoveResponseParser.java,v $</cvs:source>
 * <cvs:date>$Author: dave $</cvs:date>
 * <cvs:author>$Date: 2003/06/22 22:29:48 $</cvs:author>
 * <cvs:version>$Revision: 1.1 $</cvs:version>
 *
 * <cvs:log>
 * $Log: MoveResponseParser.java,v $
...
/**
 * An XML parser to handle a move response.
 *
 */
public class MoveResponseParser
	extends SAXDocumentHandler
	implements MoveResultHandler
	{
	/**
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("MoveResponseParser.parse(String)") ;
			System.out.println("----") ;
	...
	public void init()
		{
		//
		// Add a MoveResultParser.
		addElementHandler(
			new MoveResultParser(this)
			) ;
		}
