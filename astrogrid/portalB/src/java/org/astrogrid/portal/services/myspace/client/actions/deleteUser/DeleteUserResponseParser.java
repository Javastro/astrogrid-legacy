 ...
 *
 */
public class DeleteUserResponseParser
	 ...
	 *
	 */
	public DeleteUserResponseParser()
		{
		//
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("DeleteUserResponseParser.parse(String)") ;
			System.out.println("----") ;
	...
	public void init()
		{
		//
		// Add a DeleteUserResultParser.
		addElementHandler(
			new DeleteUserResultParser(this)
			) ;
		}
