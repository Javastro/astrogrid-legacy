 ...
 *
 */
public class CreateUserResultParser
	extends SAXElementHandler
	implements CreateUserResultHandler
	{
	/**
	 ...
	 *
	 */
	private CreateUserResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public CreateUserResultParser(CreateUserResultHandler handler)
		{
		//
	...
	protected void startElement()
		...
		if (DEBUG_FLAG) System.out.println("Start of results CreateUser") ;
		}
	...
	protected void closeElement()
		throws SAXException
		{
		if (DEBUG_FLAG) System.out.println("Close of results CreateUser") ;
		if (DEBUG_FLAG) System.out.println("----") ;
		}
