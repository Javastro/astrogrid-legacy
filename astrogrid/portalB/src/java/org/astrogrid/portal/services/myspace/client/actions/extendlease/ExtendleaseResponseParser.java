 ...
 *
 */
public class ExtendleaseResponseParser
	 ...
	 *
	 */
	public ExtendleaseResponseParser()
		{
		//
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("ExtendLeaseResponseParser.parse(String)") ;
			System.out.println("----") ;
	...
	public void init()
		{
		//
		// Add a ExtendleaseResultParser.
		addElementHandler(
			new ExtendleaseResultParser(this)
			) ;
		}
