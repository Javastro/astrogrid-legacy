/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/details/Attic/DetailsResponseParser.java,v $</cvs:source>
 * <cvs:date>$Author: dave $</cvs:date>
 * <cvs:author>$Date: 2003/06/24 10:43:25 $</cvs:author>
 * <cvs:version>$Revision: 1.2 $</cvs:version>
 *
 * <cvs:log>
 * $Log: DetailsResponseParser.java,v $
 ...
 *
 */
public class DetailsResponseParser
	...
	public void parse(String response)
		...
		if (DEBUG_FLAG)
			{
			System.out.println("DetailsResponseParser.parse(String)") ;
			System.out.println("----") ;
