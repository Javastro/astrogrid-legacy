/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/move/junit/Attic/JUnitTestCase.java,v $</cvs:source>
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.move.junit ;
...
public class JUnitTestCase
	...
	public void testMoveRequest()
		...
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
		if (DEBUG_FLAG) System.out.println("testMoveRequest") ;
		...
		MoveRequestBuilder request = new MoveRequestBuilder(FILE_NAME, COPY_NAME) ;
		if (DEBUG_FLAG)
			{
			System.out.println("----") ;
