/*
 *
 * <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/java/org/astrogrid/portal/services/myspace/client/actions/export/junit/Attic/JUnitTestCase.java,v $</cvs:source>
 ...
 *
 */
package org.astrogrid.portal.services.myspace.client.actions.export.junit ;
...
public class JUnitTestCase
	 ...
	 *
	 */
	protected static String FILE_NAME = "/clq/serv1/table3" ;
	...
	public void testExportRequest()
		...
		if (DEBUG_FLAG) System.out.println("") ;
		if (DEBUG_FLAG) System.out.println("----\"----") ;
		if (DEBUG_FLAG) System.out.println("testExportRequest") ;
		...
		//
		// Create a request.
		ExportRequestBuilder request = new ExportRequestBuilder(FILE_NAME) ;
		if (DEBUG_FLAG)
			{
			System.out.println("----") ;
		...
		String response = service.exportDataHolder(request.toString()) ;
