 ...
 *
 */
public class ChangeOwnerResultParser
	 ...
	 *
	 */
	private ChangeOwnerResultHandler handler ;

	/**
	 * Public constructor.
	 *
	 */
	public ChangeOwnerResultParser(ChangeOwnerResultHandler handler)
		{
		//
	...
	protected void startElement()
		...
		if (DEBUG_FLAG) System.out.println("Start of results ChangeOwner") ;
		}
	...
	protected void closeElement()
		throws SAXException
		{
		if (DEBUG_FLAG) System.out.println("Close of results ChangeOwner") ;
		if (DEBUG_FLAG) System.out.println("----") ;
		}
