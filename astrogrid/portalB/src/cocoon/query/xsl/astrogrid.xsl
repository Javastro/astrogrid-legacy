<?xml version="1.0"?>
<!--+
    | <cvs:source>$Source: /Users/pharriso/Work/ag/repo/git/astrogrid-mirror/astrogrid/portalB/src/cocoon/query/xsl/Attic/astrogrid.xsl,v $</cvs:source>
    | <cvs:date>$Author: KevinBenson $</cvs:date>
    | <cvs:author>$Date: 2003/07/23 15:31:46 $</cvs:author>
