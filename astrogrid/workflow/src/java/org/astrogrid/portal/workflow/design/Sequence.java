...
public class Sequence extends ActivityContainer {
  ...
  public Sequence(Activity parent) {
    super(parent);
    if (TRACE_ENABLED)
      trace("Sequence() entry/exit");
  }

  public Sequence(String communitySnippet, Element element, Activity parent) {
    super(communitySnippet, element, parent);
    if (TRACE_ENABLED)
      trace("Sequence(Element) entry/exit");
  }

  public String toXMLString() {
    if (TRACE_ENABLED)
      trace("Sequence.toXMLString() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("Sequence.toXMLString() exit");
    }
