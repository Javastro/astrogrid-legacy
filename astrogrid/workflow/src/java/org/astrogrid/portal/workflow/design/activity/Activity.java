...
public abstract class Activity {
  ...
  protected void remove() {
    ...
    try {
      ...
      if (this instanceof ActivityContainer) {
        ActivityIterator iterator = ((ActivityContainer) this).getChildren();
  ...
  public Workflow getWorkflow() {
    if (TRACE_ENABLED)
      trace("Activity.getWorkflow() entry");
    ...
    try {
      ...
      if (this instanceof Workflow) {
        ...
        Activity parent = this.getParent(), workflowCandidate = this;
      ...
      if (TRACE_ENABLED)
        trace("Activity.getWorkflow() exit");
    }
