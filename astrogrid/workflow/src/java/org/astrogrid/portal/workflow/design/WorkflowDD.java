...
public class WorkflowDD {
  ...
  public static final String COMMUNITY_ELEMENT = "community",
  ...
  public static final String TOOL_ELEMENT = "tool", TOOL_NAME_ATTR = "name";

  public static final String INPUT_ELEMENT = "input", OUTPUT_ELEMENT = "output";

  public static final String PAREMETER_ELEMENT = "parameter",
  ...
  public static final String DOCUMENTATION_ELEMENT = "documentation";
    ...
    public static final String WORKFLOW_TEMPLATE =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        + "<workflow name=\"{0}\" {1}>"
        + "{2}"
  + // community snippet
    "<description>{3}</description>" + "{4}" + // sequence by default
  "</workflow>";

    public static final String SEQUENCE_TEMPLATE =
      "<sequence>" + "{0}" + // whatever an ActivityContainer contains
  "</sequence>";

    public static final String FLOW_TEMPLATE =
      "<flow>" + "{0}" + // whatever an ActivityContainer contains
  "</flow>";
  ...
  "</step>";
    ...
    public static final String TOOL_TEMPLATE =
      "<tool name=\"{0}\" >"
        + "<documentation>"
        + "{1}"
        + "</documentation>"
        ...
        + "{2}"
  + // input parameters
    "</input>" + "<output>" + "{3}" + // output parameters
  "</output>" + "</tool>";

    public static final String PARAMETER_TEMPLATE =
      "<parameter name=\"{0}\" type=\"{1}\" location=\"{2}\" min=\"{3}\" max=\"{4}\" >"
        + "<documentation>"
        + "{5}"
        + "</documentation>"
        + "{6}"
  + // possible instream data
  "</parameter>";

    public static final String JOB_TEMPLATE =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
        + "<job name=\"{0}\" >"
  ...
  "</job>";
    ...
    public static final String JOBSTEP_TEMPLATE =
      "<jobstep name=\"{0}\" joinCondition=\"{1}\" stepNumber=\"{2}\" sequenceNumber=\"{3}\">"
        + "{4}"
  + // tool
  "</jobstep>";

    public static final String JOBTOOL_TEMPLATE =
      "<tool name=\"{0}\" >" + "<input>" + "{1}" + // input parameters
    "</input>" + "<output>" + "{2}" + // output parameters
  "</output>" + "</tool>";

    public static final String JOBPARAMETER_TEMPLATE =
      "<parameter name=\"{0}\" type=\"{1}\" " + "{2} >" +
