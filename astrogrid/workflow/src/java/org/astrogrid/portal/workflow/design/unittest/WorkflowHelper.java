...
public class WorkflowHelper {
  ...
  private static String[] workflowTable = { "JobOne", "JobTwo" };
  ...
  private static String[] queryTable = { "QueryOne", "QueryTwo" };

  /*
   * At present this returns just an Iterator of string Objects representing the names
   * of the files.
   */
  public static Vector readWorkflowList(
    String communitySnippet,
    String filter) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.readWorkflowList() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("WorkflowHelper.readWorkflowList() exit");
    }
  ...
  public static Workflow readWorkflow(String communitySnippet, String name) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.readWorkflow() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("WorkflowHelper.readWorkflow() exit");
    }
  ...
  public static boolean deleteWorkflow(String communitySnippet, String name) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.deleteWorkflow() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("WorkflowHelper.deleteWorkflow() exit");
    }
  ...
  public static boolean saveWorkflow(Workflow workflow) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.saveWorkflow() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("WorkflowHelper.saveWorkflow() exit");
    }
  ...
  public static Vector readQueryList(String communitySnippet, String filter) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.readQueryList() entry");
    ...
    try {
      ...
      if (TRACE_ENABLED)
        trace("WorkflowHelper.readQueryList() exit");
    }
  ...
  public static String readQuery(String communitySnippet, String name) {
    if (TRACE_ENABLED)
      trace("WorkflowHelper.readQuery() entry");

    try {
      return queryOne;
    } finally {
      if (TRACE_ENABLED)
        trace("WorkflowHelper.readQuery() exit");
    }
