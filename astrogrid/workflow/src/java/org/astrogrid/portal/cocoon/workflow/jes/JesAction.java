...
import org.astrogrid.portal.workflow.jes.Job;
...
public class JesAction extends AbstractAction {
  ...
  private static final String ASTROGRIDERROR_JOB_PERMISSION_DENIED =
    "AGWKFE00060",
  ...
  */
  public Map act(
    ...
    try {
      ...
      myAction =
        new JesActionImpl(redirector, resolver, objectModel, source, params);
