...
public class ARXmlHandler implements XMLHandler {
	...
	public ProcessorFactory getFactory(Element specElement) {
		...
		Element ceaAppIvornElement = specElement.getChild("ceaAppIvorn",
	                XScufl.XScuflNS);
	    String ceaAppIvorn = ceaAppIvornElement.getTextTrim();
	    
		Element ceaServiceElement = specElement.getChild("ceaServiceIvorn",
                XScufl.XScuflNS);
		String ceaServiceIvorn = ceaServiceElement.getTextTrim();		
		Element ceaInterfaceElement = specElement.getChild("ceaInterface",
                XScufl.XScuflNS);
