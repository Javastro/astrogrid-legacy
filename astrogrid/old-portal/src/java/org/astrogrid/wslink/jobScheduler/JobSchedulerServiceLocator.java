...
public class JobSchedulerServiceLocator extends org.apache.axis.client.Service implements org.astrogrid.wslink.jobScheduler.JobSchedulerService {
    ...
    public org.astrogrid.wslink.jobScheduler.JobScheduler getJobSchedulerService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.astrogrid.wslink.jobScheduler.JobSchedulerServiceSoapBindingStub _stub = new org.astrogrid.wslink.jobScheduler.JobSchedulerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.astrogrid.wslink.jobScheduler.JobScheduler.class.isAssignableFrom(serviceEndpointInterface)) {
                org.astrogrid.wslink.jobScheduler.JobSchedulerServiceSoapBindingStub _stub = new org.astrogrid.wslink.jobScheduler.JobSchedulerServiceSoapBindingStub(new java.net.URL(JobSchedulerService_address), this);
                _stub.setPortName(getJobSchedulerServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:org.astrogrid.jobScheduler", "JobSchedulerService");
    }
