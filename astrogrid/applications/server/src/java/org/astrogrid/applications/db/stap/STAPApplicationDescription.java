/*
 * $Id: STAPApplicationDescription.java,v 1.2 2008/09/03 14:19:02 pah Exp $
 * 
...
public class STAPApplicationDescription extends DBApplicationDescription {
	...
	return new STAPApplication(tool,appInterface, ds, new ApplicationEnvironment(callerAssignedID, user, getInternalComponentFactory().getIdGenerator(), conf),  lib);
