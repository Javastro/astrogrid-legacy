/*
 * $Id: SIAPApplicationDescription.java,v 1.1 2008/10/20 10:34:05 pah Exp $
 * 
...
public class SIAPApplicationDescription extends DBApplicationDescription {
	...
	return new SIAPApplication(tool,appInterface, ds, new ApplicationEnvironment(callerAssignedID, secGuard, getInternalComponentFactory().getIdGenerator(), conf),  lib);
