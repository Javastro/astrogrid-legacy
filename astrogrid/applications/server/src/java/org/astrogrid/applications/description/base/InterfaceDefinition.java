...
public class InterfaceDefinition implements ApplicationInterface {
  ...
  /** back link to the application description */ //TODO would be nice to have this final - look at getting context from jaxb...
   ...
   public InterfaceDefinition(String id, ApplicationDescription description){
       this();
       this.id = id;
...
public InterfaceDefinition(){
     ...
     */
	  ...
	  assert applicationDescription != null : "programming error cannot get parameter from interface before ApplicationDescription created ";
	...
	public String toString() {
            ...
            buffer.append(applicationDescription.getId());
