/*
 * $Id: CEAParameter.java,v 1.1 2009/04/04 20:41:54 pah Exp $
 * 
...
public @interface CEAParameter {
   String id();
   String name() default "";
   String description() default "";
   ParameterTypes type() default ParameterTypes.UNKNOWN;
