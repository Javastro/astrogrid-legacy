/*
 * $Id: MapDecoratedList.java,v 1.2 2008/09/03 14:18:43 pah Exp $
 * 
...
/**
 * A decorated list that also stores all of its members in a map using the {@link Identify#getId()} as a key. This allows for a simple
 *  retrieval of the members using the {@link #get(String)} function. Note that this is the only "map like" functionality that is exposed.
...
public class MapDecoratedList<E extends Identify> implements List<E> {
	...
	throw new  UnsupportedOperationException("MapDecoratedList.removeAll() not implemented");
    }

    public boolean retainAll(Collection<?> c) {
	// TODO not sure if I can implement efficiently
	throw new  UnsupportedOperationException("MapDecoratedList.retainAll() not implemented");
    }
