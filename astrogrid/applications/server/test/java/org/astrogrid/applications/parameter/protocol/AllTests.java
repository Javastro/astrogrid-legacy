...
public class AllTests {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("Test for org.astrogrid.applications.parameter.protocol");
        //$JUnit-BEGIN$
        suite.addTestSuite(DefaultProtocolLibraryFactoryTest.class);
        suite.addTestSuite(DefaultProtocolLibraryTest.class);
        //$JUnit-END$
        return suite;
    }
}
