/*
 * $Id: ServiceChooser.java,v 1.2 2005/07/05 08:27:01 clq2 Exp $
 * 
...
/**
 * Chooses a Service instance to run from the registry.
 * Very simple at the moment - just chooses the first one that it finds.
