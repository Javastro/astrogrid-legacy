 ...
 * @since iteration6
 */
public class CommandLineParameterAdapter implements ParameterAdapter {
    /**
     * Logger for this class
     */
    private static final Log logger = LogFactory
            .getLog(CommandLineParameterAdapter.class);

    //FIXME need to get this to actually do the double indirection.
    ...
    public CommandLineParameterAdapter(ApplicationInterface appInterface,
    ...
    public void writeBack(Object arg0) throws CeaException {
        //FIXME still need to look at writeback....
        try {
            if (desc.isFileRef()) {
                if (indirect == null) {
                    StringWriter sw = new StringWriter();
