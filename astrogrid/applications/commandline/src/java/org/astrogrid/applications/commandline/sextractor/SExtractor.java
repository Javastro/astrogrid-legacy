...
public class SExtractor extends CommandLineApplication {
   ...
   protected void preWritebackHook() {
     ...
     try {
        ...
        String band;
        ReferenceCommandLineParameterAdapter catname = (ReferenceCommandLineParameterAdapter)findParameterAdapter("CATALOG_NAME");
       ...
       ASCII2VOTableConverter conv = new ASCII2VOTableConverter(catname,(ReferenceCommandLineParameterAdapter) findParameterAdapter("PARAMETERS_NAME"), applicationEnvironment, band);
      conv.writeVOTable();
   }
   catch (IOException e) {
