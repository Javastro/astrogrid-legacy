/*
 * $Id: InitServlet.java,v 1.1 2009/05/15 23:11:11 pah Exp $
 * 
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp)
      ...
      if (method == null || method.trim().length() == 0) {
        ...
        try {
            secGuard = UWSUtils.createSecurityGuard(req);
        } catch (CertificateException e) {
            throw new ServletException("problem with security", e);
        }
        getExecutionSummary(writer, execId, secGuard);
   ...
   protected void getExecutionSummary(PrintWriter pw, String execId, SecurityGuard secGuard)
         throws ServletException {
      try {
         
        ExecutionSummaryType summary = CEAComponentContainer
               .getInstance().getQueryService().getSummary(execId, secGuard);
