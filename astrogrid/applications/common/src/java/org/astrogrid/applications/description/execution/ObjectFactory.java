...
public class ObjectFactory {
    ...
    private final static QName _Tool_QNAME = new QName("http://www.ivoa.net/xml/CEA/types/v1.2", "tool");
    private final static QName _JobId_QNAME = new QName("http://www.ivoa.net/xml/CEA/types/v1.2", "jobId");
    private final static QName _ExecutionSummary_QNAME = new QName("http://www.ivoa.net/xml/CEA/types/v1.2", "executionSummary");
    private final static QName _Message_QNAME = new QName("http://www.ivoa.net/xml/CEA/types/v1.2", "message");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ivoa.net/xml/CEA/types/v1.2", name = "tool")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ivoa.net/xml/CEA/types/v1.2", name = "jobId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ivoa.net/xml/CEA/types/v1.2", name = "executionSummary")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ivoa.net/xml/CEA/types/v1.2", name = "message")
