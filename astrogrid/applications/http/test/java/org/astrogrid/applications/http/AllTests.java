/*$Id: AllTests.java,v 1.2 2004/07/30 14:54:47 jdt Exp $
...
public class AllTests {
    ...
    public static Test suite() {
        ...
        //$JUnit-BEGIN$
        suite.addTest(new TestSuite(HttpApplicationCEAServerTest.class));
        suite.addTest(new TestSuite(HttpApplicationProviderTest.class));
        //$JUnit-END$
        return suite;
    }
}
