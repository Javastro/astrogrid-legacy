...
public class ListServiceMetadata
{
  ...
  public static void main(String[] args)
  {
    ...
    if (args.length != 2)
    {
      System.err.println("Usage: java ListServiceMetadata <queryElement> <queryElementValue>");
    }
    ...
    try
    {
      ...
      ListServiceMetadata dom = new ListServiceMetadata();
  ...
  public String generateResponse(Document doc, String queryElement, String queryElementValue)
  {
    ...
    for (int i = 0; i < nl.getLength(); i++)
    {
      ...
      if (queryElementValue.equals(matchElementValue))
      {
        ...
        String publisher = parent.getElementsByTagName("publisher").item(0).getFirstChild().getNodeValue();
        ...
        String uri = parent.getElementsByTagName("uri").item(0).getFirstChild().getNodeValue();
        String resourceURL = parent.getElementsByTagName("resourceURL").item(0).getFirstChild().getNodeValue();
        String serviceURL = parent.getElementsByTagName("serviceURL").item(0).getFirstChild().getNodeValue();
        String allowedMethod = parent.getElementsByTagName("allowedMethod").item(0).getFirstChild().getNodeValue();
        ...
        response = response + "<allowedMethod>" + allowedMethod + "</allowedMethod> \n";
