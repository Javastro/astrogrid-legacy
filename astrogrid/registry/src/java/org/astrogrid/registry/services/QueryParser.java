	...
	public static String parseQuery (String query) throws SQLException, ClassNotFoundException {
	  ...
	  if (registrySource != null){
		if (registrySource.equals("db")){
			...
			//queryResponse = reg.dbQuery(sqlQuery);
		}
		
		/* Change xmltoSQL to xmlToXML or similar */
 ...
 public static String getRegistrySource(){
	...
	String registrySource = null;
 	...
 	try {
 		...
 		parameterDoc = parameterBuilder.parse("org/astrogrid/registry/qpParameters.xml");
 	}
 	catch (ParserConfigurationException e) {
 		System.err.println(e);
 	}
