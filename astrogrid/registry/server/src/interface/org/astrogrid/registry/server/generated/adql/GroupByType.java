...
public class GroupByType  implements java.io.Serializable {
    private org.astrogrid.registry.server.generated.adql.ColumnReferenceType[] column;

    public GroupByType() {
    }

    public org.astrogrid.registry.server.generated.adql.ColumnReferenceType[] getColumn() {
        return column;
    }

    public void setColumn(org.astrogrid.registry.server.generated.adql.ColumnReferenceType[] column) {
        this.column = column;
    }

    public org.astrogrid.registry.server.generated.adql.ColumnReferenceType getColumn(int i) {
        return column[i];
    }

    public void setColumn(int i, org.astrogrid.registry.server.generated.adql.ColumnReferenceType value) {
        this.column[i] = value;
    }
