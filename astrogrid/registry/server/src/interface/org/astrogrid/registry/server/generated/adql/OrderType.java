...
public class OrderType  implements java.io.Serializable {
    private org.astrogrid.registry.server.generated.adql.ScalarExpressionType expression;
    private org.astrogrid.registry.server.generated.adql.OrderOptionType order;

    public OrderType() {
    }

    public org.astrogrid.registry.server.generated.adql.ScalarExpressionType getExpression() {
        return expression;
    }

    public void setExpression(org.astrogrid.registry.server.generated.adql.ScalarExpressionType expression) {
        this.expression = expression;
    }

    public org.astrogrid.registry.server.generated.adql.OrderOptionType getOrder() {
        return order;
    }

    public void setOrder(org.astrogrid.registry.server.generated.adql.OrderOptionType order) {
        this.order = order;
    }
