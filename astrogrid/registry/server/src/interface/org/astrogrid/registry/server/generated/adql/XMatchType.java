...
public class XMatchType  extends org.astrogrid.registry.server.generated.adql.SearchType  implements java.io.Serializable {
    private org.astrogrid.registry.server.generated.adql.XMatchTableAliasType[] table;
    private org.astrogrid.registry.server.generated.adql.ComparisonType nature;
    private org.astrogrid.registry.server.generated.adql.NumberType sigma;

    public XMatchType() {
    }

    public org.astrogrid.registry.server.generated.adql.XMatchTableAliasType[] getTable() {
        return table;
    }

    public void setTable(org.astrogrid.registry.server.generated.adql.XMatchTableAliasType[] table) {
        this.table = table;
    }

    public org.astrogrid.registry.server.generated.adql.XMatchTableAliasType getTable(int i) {
        return table[i];
    }

    public void setTable(int i, org.astrogrid.registry.server.generated.adql.XMatchTableAliasType value) {
        this.table[i] = value;
    }

    public org.astrogrid.registry.server.generated.adql.ComparisonType getNature() {
        return nature;
    }

    public void setNature(org.astrogrid.registry.server.generated.adql.ComparisonType nature) {
        this.nature = nature;
    }

    public org.astrogrid.registry.server.generated.adql.NumberType getSigma() {
        return sigma;
    }

    public void setSigma(org.astrogrid.registry.server.generated.adql.NumberType sigma) {
        this.sigma = sigma;
    }
