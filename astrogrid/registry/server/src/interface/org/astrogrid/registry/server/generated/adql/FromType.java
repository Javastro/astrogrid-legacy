...
public class FromType  implements java.io.Serializable {
    private org.astrogrid.registry.server.generated.adql.FromTableType[] table;

    public FromType() {
    }

    public org.astrogrid.registry.server.generated.adql.FromTableType[] getTable() {
        return table;
    }

    public void setTable(org.astrogrid.registry.server.generated.adql.FromTableType[] table) {
        this.table = table;
    }

    public org.astrogrid.registry.server.generated.adql.FromTableType getTable(int i) {
        return table[i];
    }

    public void setTable(int i, org.astrogrid.registry.server.generated.adql.FromTableType value) {
        this.table[i] = value;
    }
