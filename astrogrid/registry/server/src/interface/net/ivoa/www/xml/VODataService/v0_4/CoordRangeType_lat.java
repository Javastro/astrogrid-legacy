...
public class CoordRangeType_lat  implements java.io.Serializable {
    private double min;
    private double max;

    public CoordRangeType_lat() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CoordRangeType_lat)) return false;
        CoordRangeType_lat other = (CoordRangeType_lat) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CoordRangeType_lat.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/VODataService/v0.4", "CoordRangeType>lat"));
