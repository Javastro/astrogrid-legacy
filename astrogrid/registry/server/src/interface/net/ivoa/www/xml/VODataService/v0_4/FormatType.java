...
public class FormatType  implements java.io.Serializable, org.apache.axis.encoding.SimpleType {
    ...
    public FormatType(java.lang.String value) {
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += new Boolean(isIsMIMEType()).hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/VODataService/v0.4", "FormatType"));
