...
public class DataCollectionType  extends org.astrogrid.registry.server.generated.voresource.ResourceType  implements java.io.Serializable {
    ...
    private net.ivoa.www.xml.VODataService.v0_4.AccessType access;
    ...
    public net.ivoa.www.xml.VODataService.v0_4.AccessType getAccess() {
        return access;
    }

    public void setAccess(net.ivoa.www.xml.VODataService.v0_4.AccessType access) {
        this.access = access;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DataCollectionType)) return false;
        DataCollectionType other = (DataCollectionType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DataCollectionType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/VODataService/v0.4", "DataCollectionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.ivoa.net/xml/VODataService/v0.4", "Access"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/VODataService/v0.4", "AccessType"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
