...
rem
rem $Id: openjms.bat,v 1.1 2003/07/25 12:54:56 gps Exp $
rem ---------------------------------------------------------------------------
...
set CLASSPATH=%CLASSPATH%;%OPENJMS_HOME%\lib\openjms-0.7.5-rc1.jar
...
:doStop
shift
set MAINCLASS=org.exolab.jms.administration.AdminMgr
