...
//     }
   ...
   if ( (OAI_NS.equals(uri) || OAI_PREF.equals(uri)) && "record".equals(localName)) {
...
//             || (PRO_NS.equals(uri) && "profile".equals(localName)))) {
   ...
   if ((OAI_NS.equals(uri) || OAI_PREF.equals(uri)) && "metadata".equals(localName)) {
       if (metadata == null) {
      metadata = new StringWriter();
       }
       metadataFlag++;
   }
   if ((OAI_NS.equals(uri) || OAI_PREF.equals(uri)) && "identifier".equals(localName)) {
       if (identifier == null) {
   ...
   if ((OAI_NS.equals(uri) || OAI_PREF.equals(uri)) && "datestamp".equals(localName)) {
       if (datestamp == null) {
         datestamp = new StringBuffer();
       }
       datestampFlag++;
   }
   if ((OAI_NS.equals(uri) || OAI_PREF.equals(uri)) && "setSpec".equals(localName)) {
       if (setSpec == null) {
...
//                 logger.debug(metadata.toString());
                ...
                nativeRecords.put(identifier.toString().toLowerCase(), nativeRecord);
                setSpecs = null;
                identifier = null;
                metadata = null;
                recordid = null;
