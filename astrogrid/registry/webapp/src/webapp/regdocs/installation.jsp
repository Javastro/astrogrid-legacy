...
a lot in various registry documentation usually with curly brackets.</i>
 ...
 other servlet/j2ee containers and would welcome success or failure stories relating to other containers.  <br />For the purpose of most instructions here the guide will refer to tomcat.<br />
      ...
      <p>
         ...
         <ul>
            <li>Take the war file and rename it to something you prefer e.g. registry.war (be sure to keep the .war ending).  Typical names are "astrogrid-registry.war" or "registry.war"</li>
            <li>Go to your Tomcat manager e.g. http://localhost:8080/manager/html (this may ask for a username and password ask your admin or check {tomcat}/conf/tomcat-users.xml for a user with the role of manager)</li>
            <li>If you do not have access to Tomcat manager because it is restricted on your server you may also copy the war file into the {tomcat}/webapps directory to install.</li>
            <li>Tomcat by default should unpack the war file into a directory in that webapps directory.  
                Directory Name should be the same as the war file minus the ".war" part.</li>			
            <li><strong>You should be done (for the installation part now for Configure) you should be able to access the url: http://{server}:{port}/{context} (optionally you can also check the webapps for a directory to verify).</strong></li>
            <li>The Configure will be on the menu at the left hand side of your Registry web application.</li>
      ...
      <h2>Handling Packed wars</h2>
		...
		database. SEE THE 3RD POINT BELOW to set a property to your database.
			<ul>
			  <li>Find the eXist zip file corresponding to this release ex: astrogrid-registry-eXist.zip located at: <a href='http://www.astrogrid.org/maven/org.astrogrid/zips'>Zips Directory</a></li>
