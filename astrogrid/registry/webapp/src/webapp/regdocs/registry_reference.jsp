...
sections on other certain ideas on manipulating the properties to help you in certain objectives you wish to do with the registry.
      ...
      The XMLDB driver to be the registered xml database.</li>
         <li>xmldb.admin.user -- 
      The user used to create Resources or collections, and startup/shutdown the internal eXist database if it is internally being ran.</li>
	  ...
	  The ip addresses restricted for web service Update calls normally from other components.  You may use expressions as well ex: 127.*  by default it is set to 127.0.0.1.</li>	  
      ...
      Does this registry need to do harvesting.</li>
         <li>reg.amend.oaipublish.1.0 -- 
      The url to the oai publishing url for 1.0, default is set to astrogrid servlet, needs to be changed if your context is not astrogrid-registry.</li>
      ...
      (Advanced) Declare the namespaces used on the registry, based on registry resource version 1.0.</li>      
