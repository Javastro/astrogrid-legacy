...
<p>
Below you will sections about eXist database and information of procedures you may wish to implement.  Advise if your
using eXist bundled inside your web application to move it out to another directory.
</p>
...
<p>
<b>eXist embedded (Moving your Data Out)</b><br />
...
<p>
<b>Making backups and upgrades</b><br />
...
everything correct again.<br /><br />
            To make backups of the xml files which is also good you can do this in a number of ways.<br />
            1.) commandline.  You will find a backupandrestore.{sh/bat} scripts bundled for embedded eXist located in WEB-INF. Or found
            here: <a href='http://exist.sourceforge.net/backup.html'>Info</a>  For embedded users the -ouri parameter will be xmldb:exist://{server}:{port}/{registry context}/xmlrpc   <br />            
            2.) eXist provides a client GUI to allow you to do many things internally to your db including backups and restores.  You should be able to
            click on the 'Launch' button located at <a href='http://exist.sourceforge.net/'>eXist</a><br />
<hr />
</p>
<p>
<b>Installing eXist externally</b> <br />
	You may for your own reasons want to install eXist straight from eXist website at http://exist.sourceforge.net.
			The download file is on the home page of eXist and see the <a href="http://exist.sourceforge.net/quickstart.html">quickstart guide</a> for 
			other info on installing such as on headless systems. <br />
		    Once installed here are some things to be customized for the astrogrid registry:
		    <ul>
		        <li>in the bin/functions.d/eXist-settings.sh set set_exist_options() to have a -Xmx400M for 400mb memory. Only needed for Full Registries
		        *For windows change the 128000k to 400M in the startup.bat. Memory is not much of an issue as much with its now streaming api service, but advised to increase.
		        </li>
		    	<li>Finally remember much like the above instructions to change your xmldb.uri JNDI property to your eXist and by default eXist runs on port 8080 this can be changed
		    	at EXIST_HOME/tools/jetty/etc/jetty.xml you can change the 8080 to 6080 for instance</li>
		   </ul>
<br />
</p>
  </body>
