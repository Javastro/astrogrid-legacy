...
<html>
<head><title>Browse to change Status</title>
...
Change all Entries below to the chosen status. Custom/None means do not change 'all' entries
      ...
      for (int n=0;n<resources.getLength();n++) {
         ...
         if(xsiType.indexOf(":") != -1) {
           xsiType = xsiType.substring(xsiType.indexOf(":")+1);
            ...
            out.write("<td>");
            out.write("<a href=../viewResourceEntry.jsp?IVORN="+java.net.URLEncoder.encode(("ivo://" + ivoStr),"UTF-8")+">XML,</a>  ");
