 ...
 * Schema.
 * $Id: ParamDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class PARAMDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PARAMDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _VALUES
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.VALUES.class, "_VALUES", "VALUES", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PARAM target = (PARAM) object;
                    target.setVALUES( (org.astrogrid.registry.generated.package.VALUES) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.PARAMDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.PARAM.class;
