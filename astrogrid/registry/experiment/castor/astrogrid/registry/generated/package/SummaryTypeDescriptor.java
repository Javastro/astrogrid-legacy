 ...
 * Schema.
 * $Id: SummaryTypeDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class SummaryTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SummaryTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _source
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.Source.class, "_source", "Source", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SummaryType target = (SummaryType) object;
                    target.setSource( (org.astrogrid.registry.generated.package.Source) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.Source();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VOResource/v0.9");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.SummaryTypeDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.SummaryType.class;
