 ...
 * Schema.
 * $Id: FIELDItemDescriptor.java,v 1.1 2004/03/03 03:40:59 pcontrer Exp $
 */
...
public class FIELDItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FIELDItemDescriptor() {
        ...
        //-- _VALUESList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.VALUES.class, "_VALUESList", "VALUES", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    FIELDItem target = (FIELDItem) object;
                    target.addVALUES( (org.astrogrid.registry.generated.package.VALUES) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.VALUES();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VOTable/v1.0");
        ...
        desc.setValidator(fieldValidator);
        //-- _LINK
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.LINK.class, "_LINK", "LINK", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    FIELDItem target = (FIELDItem) object;
                    target.setLINK( (org.astrogrid.registry.generated.package.LINK) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.FIELDItemDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.FIELDItem.class;
