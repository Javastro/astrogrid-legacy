 ...
 * Schema.
 * $Id: VOTABLEDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class VOTABLEDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VOTABLEDescriptor() {
        ...
        //-- _version
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.types.VOTABLEVersionType.class, "_version", "version", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VOTABLE target = (VOTABLE) object;
                    target.setVersion( (org.astrogrid.registry.generated.package.types.VOTABLEVersionType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(org.astrogrid.registry.generated.package.types.VOTABLEVersionType.class, handler));
        ...
        desc.setValidator(fieldValidator);
        //-- _DEFINITIONS
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.DEFINITIONS.class, "_DEFINITIONS", "DEFINITIONS", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    VOTABLE target = (VOTABLE) object;
                    target.setDEFINITIONS( (org.astrogrid.registry.generated.package.DEFINITIONS) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.DEFINITIONS();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VOTable/v1.0");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.VOTABLEDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.VOTABLE.class;
