 ...
 * Schema.
 * $Id: TableDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class TABLEDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TABLEDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _FIELDList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.FIELD.class, "_FIELDList", "FIELD", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TABLE target = (TABLE) object;
                    target.addFIELD( (org.astrogrid.registry.generated.package.FIELD) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.FIELD();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VOTable/v1.0");
        ...
        desc.setValidator(fieldValidator);
        //-- _DATA
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.DATA.class, "_DATA", "DATA", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TABLE target = (TABLE) object;
                    target.setDATA( (org.astrogrid.registry.generated.package.DATA) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.DATA();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VOTable/v1.0");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.TABLEDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.TABLE.class;
