 ...
 * Schema.
 * $Id: SpatialTypeDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class SpatialTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SpatialTypeDescriptor() {
        ...
        //-- _regionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.generated.package.Region.class, "_regionList", "Region", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SpatialType target = (SpatialType) object;
                    target.addRegion( (org.astrogrid.registry.generated.package.Region) value);
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.generated.package.Region();
            }
        } );
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                if(!target.hasSpatialResolution())
                    return null;
                return new java.lang.Float(target.getSpatialResolution());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setSpatialResolution( ((java.lang.Float)value).floatValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                if(!target.hasRegionOfRegard())
                    return null;
                return new java.lang.Float(target.getRegionOfRegard());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setRegionOfRegard( ((java.lang.Float)value).floatValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.SpatialTypeDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.SpatialType.class;
