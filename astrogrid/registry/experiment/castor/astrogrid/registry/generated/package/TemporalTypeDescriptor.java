 ...
 * Schema.
 * $Id: TemporalTypeDescriptor.java,v 1.1 2004/03/03 03:40:58 pcontrer Exp $
 */
...
public class TemporalTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TemporalTypeDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                if(!target.hasTemporalResolution())
                    return null;
                return new java.lang.Float(target.getTemporalResolution());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setTemporalResolution( ((java.lang.Float)value).floatValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.generated.package.TemporalTypeDescriptor()
    ...
    {
        return org.astrogrid.registry.generated.package.TemporalType.class;
