 ...
 * Schema.
 * $Id: OrganisationTypeDescriptor.java,v 1.1 2004/03/02 05:37:32 pcontrer Exp $
 */
 ...
 */
public class OrganisationTypeDescriptor extends ResourceTypeDescriptor {
    ...
    public OrganisationTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.OrganisationTypeDescriptor()
    ...
    {
        return org.astrogrid.registry.OrganisationType.class;
