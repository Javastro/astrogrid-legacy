 ...
 * Schema.
 * $Id: SimpleImageAccessType.java,v 1.1 2004/03/02 05:37:32 pcontrer Exp $
 */
...
import org.astrogrid.registry.types.ImageServiceTypeType;
 ...
 * 
 * @version $Revision: 1.1 $ $Date: 2004/03/02 05:37:32 $
 */
...
implements java.io.Serializable
{
     ...
     *  
     */
    private org.astrogrid.registry.types.ImageServiceTypeType _imageServiceType;
     ...
     *  
     */
    private org.astrogrid.registry.MaxQueryRegionSize _maxQueryRegionSize;
     ...
     *  
     */
    private org.astrogrid.registry.MaxImageExtent _maxImageExtent;
     ...
     *  
     */
    private org.astrogrid.registry.MaxImageSize _maxImageSize;
    ...
    public SimpleImageAccessType() {
        super();
    } //-- org.astrogrid.registry.SimpleImageAccessType()
     ...
     */
    public org.astrogrid.registry.types.ImageServiceTypeType getImageServiceType()
    {
        return this._imageServiceType;
    } //-- org.astrogrid.registry.types.ImageServiceTypeType getImageServiceType() 
     ...
     */
    public org.astrogrid.registry.MaxImageExtent getMaxImageExtent()
    {
        return this._maxImageExtent;
    } //-- org.astrogrid.registry.MaxImageExtent getMaxImageExtent() 
     ...
     */
    public org.astrogrid.registry.MaxImageSize getMaxImageSize()
    {
        return this._maxImageSize;
    } //-- org.astrogrid.registry.MaxImageSize getMaxImageSize() 
     ...
     */
    public org.astrogrid.registry.MaxQueryRegionSize getMaxQueryRegionSize()
    {
        return this._maxQueryRegionSize;
    } //-- org.astrogrid.registry.MaxQueryRegionSize getMaxQueryRegionSize() 
     ...
     */
    public void setImageServiceType(org.astrogrid.registry.types.ImageServiceTypeType imageServiceType)
    {
        this._imageServiceType = imageServiceType;
    } //-- void setImageServiceType(org.astrogrid.registry.types.ImageServiceTypeType) 
     ...
     */
    public void setMaxImageExtent(org.astrogrid.registry.MaxImageExtent maxImageExtent)
    {
        this._maxImageExtent = maxImageExtent;
    } //-- void setMaxImageExtent(org.astrogrid.registry.MaxImageExtent) 
     ...
     */
    public void setMaxImageSize(org.astrogrid.registry.MaxImageSize maxImageSize)
    {
        this._maxImageSize = maxImageSize;
    } //-- void setMaxImageSize(org.astrogrid.registry.MaxImageSize) 
     ...
     * 'maxQueryRegionSize'.
     */
    public void setMaxQueryRegionSize(org.astrogrid.registry.MaxQueryRegionSize maxQueryRegionSize)
    {
        this._maxQueryRegionSize = maxQueryRegionSize;
    } //-- void setMaxQueryRegionSize(org.astrogrid.registry.MaxQueryRegionSize) 
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.astrogrid.registry.SimpleImageAccessType) Unmarshaller.unmarshal(org.astrogrid.registry.SimpleImageAccessType.class, reader);
