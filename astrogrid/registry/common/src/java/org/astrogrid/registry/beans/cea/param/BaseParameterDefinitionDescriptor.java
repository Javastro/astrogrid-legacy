 ...
 * Schema.
 * $Id: BaseParameterDefinitionDescriptor.java,v 1.4 2004/04/05 14:36:12 KevinBenson Exp $
 */
...
public class BaseParameterDefinitionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BaseParameterDefinitionDescriptor() {
        ...
        //-- _type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.cea.param.types.ParameterTypes.class, "_type", "type", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BaseParameterDefinition target = (BaseParameterDefinition) object;
                    target.setType( (org.astrogrid.registry.beans.cea.param.types.ParameterTypes) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(org.astrogrid.registry.beans.cea.param.types.ParameterTypes.class, handler));
        desc.setImmutable(true);
        desc.setRequired(true);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _UI_Description
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.cea.param.XhtmlDocumentation.class, "_UI_Description", "UI_Description", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BaseParameterDefinition target = (BaseParameterDefinition) object;
                    target.setUI_Description( (org.astrogrid.registry.beans.cea.param.XhtmlDocumentation) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.beans.cea.param.XhtmlDocumentation();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.astrogrid.org/schema/AGParameterDefinition/v1");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.cea.param.BaseParameterDefinitionDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.cea.param.BaseParameterDefinition.class;
