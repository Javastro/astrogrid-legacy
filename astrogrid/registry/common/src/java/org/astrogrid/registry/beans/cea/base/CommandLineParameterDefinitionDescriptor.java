 ...
 * Schema.
 * $Id: CommandLineParameterDefinitionDescriptor.java,v 1.4 2004/04/05 14:36:12 KevinBenson Exp $
 */
 ...
 */
public class CommandLineParameterDefinitionDescriptor extends org.astrogrid.registry.beans.cea.param.BaseParameterDefinitionDescriptor {
    ...
    public CommandLineParameterDefinitionDescriptor() {
        super();
        setExtendsWithoutFlatten(new org.astrogrid.registry.beans.cea.param.BaseParameterDefinitionDescriptor());
        ...
        desc.setValidator(fieldValidator);
        //-- _switchType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.cea.base.types.SwitchTypes.class, "_switchType", "switchType", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CommandLineParameterDefinition target = (CommandLineParameterDefinition) object;
                    target.setSwitchType( (org.astrogrid.registry.beans.cea.base.types.SwitchTypes) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(org.astrogrid.registry.beans.cea.base.types.SwitchTypes.class, handler));
        desc.setImmutable(true);
        addFieldDescriptor(desc);
    ...
    } //-- org.astrogrid.registry.beans.cea.base.CommandLineParameterDefinitionDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.cea.base.CommandLineParameterDefinition.class;
