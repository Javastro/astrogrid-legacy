...
public class RegistryConfig
    ...
    *
    */
   public static final String REGISTRY_VERSION = "registry.version";
 ...
 */   
   ...
   *
   */
   private static String regVersion = "0_0";
   ...
   */
   public static String getRegistryVersion() {
         //
         // Try reading our config property.
         if ("0_0".equals(regVersion)){
            if (DEBUG_FLAG) System.out.println("getRegistryVersion()") ;
            if (DEBUG_FLAG) System.out.println("  Trying config property '" + REGISTRY_VERSION + "'") ;
            regVersion = getProperty(REGISTRY_VERSION);
            if (DEBUG_FLAG) System.out.println("  Config property result : " + regVersion);
         }
         return regVersion;
   }
   ...
   public static IRegistryInfo loadRegistryInfo() {
      ...
      String className = "org.astrogrid.registry.versionNS.vr" + getRegistryVersion() + ".Registry";
      if (DEBUG_FLAG) System.out.println("  registry class  : " + className);
      Class reg = null;
      try {
