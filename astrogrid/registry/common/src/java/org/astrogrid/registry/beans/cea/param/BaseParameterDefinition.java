 ...
 * Schema.
 * $Id: BaseParameterDefinition.java,v 1.2 2004/03/19 08:16:47 KevinBenson Exp $
 */

package org.astrogrid.registry.beans.cea.param;
...
import org.astrogrid.registry.beans.cea.param.types.ParameterTypes;
...
implements java.io.Serializable
{
     ...
     * Field _type
     */
    private org.astrogrid.registry.beans.cea.param.types.ParameterTypes _type;
     ...
     */
    private org.astrogrid.registry.beans.cea.param.XhtmlDocumentation _UI_Description;
    ...
    public BaseParameterDefinition() {
        super();
    } //-- org.astrogrid.registry.beans.cea.param.BaseParameterDefinition()
     ...
     */
    public org.astrogrid.registry.beans.cea.param.types.ParameterTypes getType()
    {
        return this._type;
    } //-- org.astrogrid.registry.beans.cea.param.types.ParameterTypes getType() 
     ...
     */
    public org.astrogrid.registry.beans.cea.param.XhtmlDocumentation getUI_Description()
    {
        return this._UI_Description;
    } //-- org.astrogrid.registry.beans.cea.param.XhtmlDocumentation getUI_Description() 
     ...
     */
    public void setType(org.astrogrid.registry.beans.cea.param.types.ParameterTypes type)
    {
        this._type = type;
    } //-- void setType(org.astrogrid.registry.beans.cea.param.types.ParameterTypes) 
     ...
     */
    public void setUI_Description(org.astrogrid.registry.beans.cea.param.XhtmlDocumentation UI_Description)
    {
        this._UI_Description = UI_Description;
    } //-- void setUI_Description(org.astrogrid.registry.beans.cea.param.XhtmlDocumentation) 
     ...
     * @param reader
     */
    public static org.astrogrid.registry.beans.cea.param.BaseParameterDefinition unmarshalBaseParameterDefinition(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.astrogrid.registry.beans.cea.param.BaseParameterDefinition) Unmarshaller.unmarshal(org.astrogrid.registry.beans.cea.param.BaseParameterDefinition.class, reader);
    } //-- org.astrogrid.registry.beans.cea.param.BaseParameterDefinition unmarshalBaseParameterDefinition(java.io.Reader) 
