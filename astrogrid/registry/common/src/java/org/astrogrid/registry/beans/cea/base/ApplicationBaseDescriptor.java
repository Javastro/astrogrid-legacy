 ...
 * Schema.
 * $Id: ApplicationBaseDescriptor.java,v 1.4 2004/04/05 14:36:12 KevinBenson Exp $
 */
...
public class ApplicationBaseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ApplicationBaseDescriptor() {
        ...
        //-- _parameters
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.cea.base.Parameters.class, "_parameters", "Parameters", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ApplicationBase target = (ApplicationBase) object;
                    target.setParameters( (org.astrogrid.registry.beans.cea.base.Parameters) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.beans.cea.base.Parameters();
            }
        } );
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.cea.base.ApplicationBaseDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.cea.base.ApplicationBase.class;
