 ...
 * Schema.
 * $Id: TableTypeDescriptor.java,v 1.8 2004/04/05 14:36:11 KevinBenson Exp $
 */
...
public class TableTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TableTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _columnList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.resource.dataservice.ParamType.class, "_columnList", "Column", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TableType target = (TableType) object;
                    target.addColumn( (org.astrogrid.registry.beans.resource.dataservice.ParamType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.resource.dataservice.TableTypeDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.resource.dataservice.TableType.class;
