 ...
 * Schema.
 * $Id: TDocumentationDescriptor.java,v 1.4 2004/04/05 14:36:12 KevinBenson Exp $
 */
...
public class TDocumentationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TDocumentationDescriptor() {
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.cea.param.TDocumentationDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.cea.param.TDocumentation.class;
