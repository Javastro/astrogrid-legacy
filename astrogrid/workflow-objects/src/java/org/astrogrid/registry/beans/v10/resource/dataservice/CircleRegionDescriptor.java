 ...
 * Schema.
 * $Id: CircleRegionDescriptor.java,v 1.2 2007/01/04 16:26:26 clq2 Exp $
 */
...
/**
 * Class CircleRegionDescriptor.
 * 
 * @version $Revision: 1.2 $ $Date: 2007/01/04 16:26:26 $
 */
public class CircleRegionDescriptor extends org.astrogrid.registry.beans.v10.resource.dataservice.RegionDescriptor {
    ...
    public CircleRegionDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CircleRegion target = (CircleRegion) object;
        ...
        //-- _center
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.v10.resource.dataservice.Position.class, "_center", "center", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CircleRegion target = (CircleRegion) object;
                    target.setCenter( (org.astrogrid.registry.beans.v10.resource.dataservice.Position) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.beans.v10.resource.dataservice.Position();
            }
        } );
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.v10.resource.dataservice.CircleRegionDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.v10.resource.dataservice.CircleRegion.class;
