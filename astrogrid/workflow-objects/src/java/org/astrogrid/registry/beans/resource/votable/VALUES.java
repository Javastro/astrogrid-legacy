 ...
 * Schema.
 * $Id: VALUES.java,v 1.11 2005/01/23 12:51:31 jdt Exp $
 */
 ...
 * Class VALUES.
 * 
 * @version $Revision: 1.11 $ $Date: 2005/01/23 12:51:31 $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof VALUES) {
            ...
            if (this._type != null) {
                ...
                return false;
            if (this._null != null) {
                if (temp._null == null) return false;
                else if (!(this._null.equals(temp._null))) 
                    return false;
            }
            else if (temp._null != null)
                return false;
            if (this._invalid != null) {
                if (temp._invalid == null) return false;
                else if (!(this._invalid.equals(temp._invalid))) 
                    return false;
            }
            else if (temp._invalid != null)
                return false;
            if (this._MIN != null) {
                if (temp._MIN == null) return false;
                else if (!(this._MIN.equals(temp._MIN))) 
                    return false;
            }
            else if (temp._MIN != null)
                return false;
            if (this._MAX != null) {
                if (temp._MAX == null) return false;
                else if (!(this._MAX.equals(temp._MAX))) 
                    return false;
            }
