 ...
 * Schema.
 * $Id: STREAM.java,v 1.6 2004/08/04 13:58:38 nw Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof STREAM) {
            ...
            if (this._actuate != null) {
                if (temp._actuate == null) return false;
                else if (!(this._actuate.equals(temp._actuate))) 
                    return false;
            }
            else if (temp._actuate != null)
                return false;
            ...
            if (this._expires != null) {
                if (temp._expires == null) return false;
                else if (!(this._expires.equals(temp._expires))) 
                    return false;
            }
            else if (temp._expires != null)
                return false;
