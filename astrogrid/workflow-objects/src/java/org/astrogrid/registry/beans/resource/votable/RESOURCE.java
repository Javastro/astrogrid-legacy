 ...
 * Schema.
 * $Id: RESOURCE.java,v 1.14 2007/01/04 16:26:13 clq2 Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof RESOURCE) {
            ...
            if (this._INFOList != null) {
                ...
                return false;
            if (this._COOSYSList != null) {
                if (temp._COOSYSList == null) return false;
                else if (!(this._COOSYSList.equals(temp._COOSYSList))) 
                    return false;
            }
            else if (temp._COOSYSList != null)
                return false;
