 ...
 * Schema.
 * $Id: VOTableColumns.java,v 1.11 2005/01/23 12:51:09 jdt Exp $
 */
 ...
 *  
 * 
 * @version $Revision: 1.11 $ $Date: 2005/01/23 12:51:09 $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof VOTableColumns) {
        
            VOTableColumns temp = (VOTableColumns)obj;
            if (this._FIELDList != null) {
                if (temp._FIELDList == null) return false;
                else if (!(this._FIELDList.equals(temp._FIELDList))) 
                    return false;
            }
            else if (temp._FIELDList != null)
                return false;
            return true;
        }
        return false;
