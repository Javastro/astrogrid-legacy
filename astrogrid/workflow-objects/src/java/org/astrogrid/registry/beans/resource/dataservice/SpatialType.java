 ...
 * Schema.
 * $Id: SpatialType.java,v 1.11 2005/01/23 12:51:11 jdt Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof SpatialType) {
        
            SpatialType temp = (SpatialType)obj;
            if (this._regionList != null) {
                ...
                return false;
            if (this._spatialResolution != temp._spatialResolution)
                return false;
            if (this._has_spatialResolution != temp._has_spatialResolution)
                return false;
