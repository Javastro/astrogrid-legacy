 ...
 * Schema.
 * $Id: LINK.java,v 1.11 2005/01/23 12:51:33 jdt Exp $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof LINK) {
            ...
            if (this._contentRole != null) {
                if (temp._contentRole == null) return false;
                else if (!(this._contentRole.equals(temp._contentRole))) 
                    return false;
            }
            else if (temp._contentRole != null)
                return false;
            if (this._contentType != null) {
                if (temp._contentType == null) return false;
                else if (!(this._contentType.equals(temp._contentType))) 
                    return false;
            }
            else if (temp._contentType != null)
                return false;
            if (this._title != null) {
            ...
            if (this._href != null) {
                ...
                return false;
            if (this._gref != null) {
                if (temp._gref == null) return false;
                else if (!(this._gref.equals(temp._gref))) 
                    return false;
            }
            else if (temp._gref != null)
                return false;
