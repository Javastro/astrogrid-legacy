 ...
 * Schema.
 * $Id: PARAM.java,v 1.11 2005/01/23 12:51:37 jdt Exp $
 */
 ...
 * Class PARAM.
 * 
 * @version $Revision: 1.11 $ $Date: 2005/01/23 12:51:37 $
 */
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof PARAM) {
            ...
            if (this._precision != null) {
                if (temp._precision == null) return false;
                else if (!(this._precision.equals(temp._precision))) 
                    return false;
            }
            else if (temp._precision != null)
                return false;
            if (this._width != temp._width)
                return false;
            if (this._has_width != temp._has_width)
                return false;
            if (this._ref != null) {
            ...
            if (this._VALUES != null) {
                if (temp._VALUES == null) return false;
                else if (!(this._VALUES.equals(temp._VALUES))) 
                    return false;
            }
            else if (temp._VALUES != null)
                return false;
