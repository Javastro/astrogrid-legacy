 ...
 * Schema.
 * $Id: CircleRegionType.java,v 1.11 2005/01/23 12:51:11 jdt Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof CircleRegionType) {
        
            CircleRegionType temp = (CircleRegionType)obj;
            ...
            if (this._centerPosition != null) {
                if (temp._centerPosition == null) return false;
                else if (!(this._centerPosition.equals(temp._centerPosition))) 
                    return false;
            }
            else if (temp._centerPosition != null)
                return false;
