 ...
 * Schema.
 * $Id: TR.java,v 1.11 2005/01/23 12:51:31 jdt Exp $
 */
...
implements java.io.Serializable
{
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof TR) {
            ...
            TR temp = (TR)obj;
            if (this._TDList != null) {
                if (temp._TDList == null) return false;
                else if (!(this._TDList.equals(temp._TDList))) 
                    return false;
            }
            else if (temp._TDList != null)
                return false;
            return true;
        }
        return false;
