 ...
 * Schema.
 * $Id: BaseParameterDefinitionDescriptor.java,v 1.32 2004/12/03 14:47:41 jdt Exp $
 */
...
public class BaseParameterDefinitionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BaseParameterDefinitionDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _optionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.applications.beans.v1.parameters.OptionList.class, "_optionList", "OptionList", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                BaseParameterDefinition target = (BaseParameterDefinition) object;
                return target.getOptionList();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BaseParameterDefinition target = (BaseParameterDefinition) object;
                    target.setOptionList( (org.astrogrid.applications.beans.v1.parameters.OptionList) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.applications.beans.v1.parameters.OptionList();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.astrogrid.org/schema/AGParameterDefinition/v1");
