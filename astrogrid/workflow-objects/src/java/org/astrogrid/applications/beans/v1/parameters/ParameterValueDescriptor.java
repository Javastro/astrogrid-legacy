 ...
 * Schema.
 * $Id: ParameterValueDescriptor.java,v 1.36 2007/01/04 16:26:32 clq2 Exp $
 */
 ...
 * 
 * @version $Revision: 1.36 $ $Date: 2007/01/04 16:26:32 $
 */
public class ParameterValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ParameterValueDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _indirect
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_indirect", "indirect", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ParameterValue target = (ParameterValue) object;
                if(!target.hasIndirect())
                    return null;
                return new Boolean(target.getIndirect());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    if (value == null) {
                        target.deleteIndirect();
                        return;
                    }
                    target.setIndirect( ((Boolean)value).booleanValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.applications.beans.v1.parameters.ParameterValueDescriptor()
    ...
    {
        return org.astrogrid.applications.beans.v1.parameters.ParameterValue.class;
