...
package org.astrogrid.jes.service.v1.cearesults.wrapper;

public class _putResults  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _putResults)) return false;
        _putResults other = (_putResults) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_putResults.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:cea/resultslistener-wrapper/v1", ">putResults"));
