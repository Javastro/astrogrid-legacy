...
public class JobExecutionRecordType  extends org.astrogrid.jes.beans.v1.axis.executionrecord.ExecutionRecordType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof JobExecutionRecordType)) return false;
        JobExecutionRecordType other = (JobExecutionRecordType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(JobExecutionRecordType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.astrogrid.org/schema/ExecutionRecord/v1", "job-execution-record-type"));
