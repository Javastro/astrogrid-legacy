 ...
 * Schema.
 * $Id: ParamDescriptor.java,v 1.2 2005/07/05 08:26:55 clq2 Exp $
 */
...
public class ParamDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ParamDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _dataType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.astrogrid.registry.beans.v10.resource.dataservice.DataType.class, "_dataType", "dataType", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Param target = (Param) object;
                    target.setDataType( (org.astrogrid.registry.beans.v10.resource.dataservice.DataType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.astrogrid.registry.beans.v10.resource.dataservice.DataType();
            }
        } );
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.ivoa.net/xml/VODataService/v0.5");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.astrogrid.registry.beans.v10.resource.dataservice.ParamDescriptor()
    ...
    {
        return org.astrogrid.registry.beans.v10.resource.dataservice.Param.class;
