 ...
 */
public class ComparisonPredTypeImpl extends org.astrogrid.adql.beans.impl.SearchTypeImpl implements org.astrogrid.adql.beans.ComparisonPredType
{
     ...
     */
    public org.astrogrid.adql.beans.ComparisonType.Enum getComparison()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.astrogrid.adql.beans.ComparisonType xgetComparison()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.ComparisonType target = null;
            target = (org.astrogrid.adql.beans.ComparisonType)get_store().find_attribute_user(COMPARISON$2);
            return target;
        }
    }
     ...
     */
    public void setComparison(org.astrogrid.adql.beans.ComparisonType.Enum comparison)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetComparison(org.astrogrid.adql.beans.ComparisonType comparison)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.astrogrid.adql.beans.ComparisonType)get_store().add_attribute_user(COMPARISON$2);
            }
