 ...
 */
public class UserDefinedFunctionTypeImpl extends org.astrogrid.adql.beans.impl.ScalarExpressionTypeImpl implements org.astrogrid.adql.beans.UserDefinedFunctionType
{
     ...
     */
    public org.astrogrid.adql.beans.ScalarExpressionType[] getParamsArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.astrogrid.adql.beans.ScalarExpressionType getParamsArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.ScalarExpressionType target = null;
            target = (org.astrogrid.adql.beans.ScalarExpressionType)get_store().find_element_user(PARAMS$2, i);
            if (target == null)
            {
     ...
     */
    public void setParamsArray(org.astrogrid.adql.beans.ScalarExpressionType[] paramsArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setParamsArray(int i, org.astrogrid.adql.beans.ScalarExpressionType params)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.astrogrid.adql.beans.ScalarExpressionType insertNewParams(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.ScalarExpressionType target = null;
            target = (org.astrogrid.adql.beans.ScalarExpressionType)get_store().insert_element_user(PARAMS$2, i);
            return target;
        }
    }
     ...
     */
    public org.astrogrid.adql.beans.ScalarExpressionType addNewParams()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.ScalarExpressionType target = null;
            target = (org.astrogrid.adql.beans.ScalarExpressionType)get_store().add_element_user(PARAMS$2);
            return target;
        }
    }
