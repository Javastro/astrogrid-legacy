...
public class LikePredTypeImpl extends org.astrogrid.adql.beans.impl.SearchTypeImpl implements org.astrogrid.adql.beans.LikePredType
{
     ...
     */
    public org.astrogrid.adql.beans.AtomType getPattern()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.astrogrid.adql.beans.AtomType target = null;
            target = (org.astrogrid.adql.beans.AtomType)get_store().find_element_user(PATTERN$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPattern(org.astrogrid.adql.beans.AtomType pattern)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.astrogrid.adql.beans.AtomType)get_store().add_element_user(PATTERN$2);
            }
            target.set(pattern);
        }
    }
     ...
     */
    public org.astrogrid.adql.beans.AtomType addNewPattern()
    {
        synchronized (monitor())
        {
            check_orphaned();
