 ...
 */
public interface UserDefinedFunctionType extends org.astrogrid.adql.beans.ScalarExpressionType
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)schemaorg_apache_xmlbeans.system.s00D95B496A788C4D65664035BC163E1A.TypeSystemHolder.typeSystem.resolveHandle("userdefinedfunctiontype9b78type");
     ...
     */
    org.astrogrid.adql.beans.ScalarExpressionType[] getParamsArray();
    
    /**
     * Gets ith "Params" element
     */
    org.astrogrid.adql.beans.ScalarExpressionType getParamsArray(int i);
     ...
     */
    void setParamsArray(org.astrogrid.adql.beans.ScalarExpressionType[] paramsArray);
    
    /**
     * Sets ith "Params" element
     */
    void setParamsArray(int i, org.astrogrid.adql.beans.ScalarExpressionType params);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "Params" element
     */
    org.astrogrid.adql.beans.ScalarExpressionType insertNewParams(int i);
    
    /**
     * Appends and returns a new empty value (as xml) as the last "Params" element
     */
    org.astrogrid.adql.beans.ScalarExpressionType addNewParams();
