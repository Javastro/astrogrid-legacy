...
public class QueryRequest  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.vso.QueryRequestBlock block;
    ...
    public QueryRequest(
           ...
           org.astrogrid.solarsearch.ws.vso.QueryRequestBlock block) {
     ...
     * @return block
     */
    public org.astrogrid.solarsearch.ws.vso.QueryRequestBlock getBlock() {
        return block;
    }
     ...
     * @param block
     */
    public void setBlock(org.astrogrid.solarsearch.ws.vso.QueryRequestBlock block) {
        this.block = block;
    }
