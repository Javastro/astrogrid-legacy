...
public class VSOiServiceLocator extends org.apache.axis.client.Service implements org.astrogrid.solarsearch.ws.vso.VSOiService {
    ...
    public org.astrogrid.solarsearch.ws.vso.VSOiPort getsdacVSOi() throws javax.xml.rpc.ServiceException {
    ...
    public org.astrogrid.solarsearch.ws.vso.VSOiPort getsdacVSOi(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.astrogrid.solarsearch.ws.vso.VSOiBindingStub _stub = new org.astrogrid.solarsearch.ws.vso.VSOiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.astrogrid.solarsearch.ws.vso.VSOiPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.astrogrid.solarsearch.ws.vso.VSOiBindingStub _stub = new org.astrogrid.solarsearch.ws.vso.VSOiBindingStub(new java.net.URL(sdacVSOi_address), this);
                _stub.setPortName(getsdacVSOiWSDDServiceName());
                return _stub;
            }
        }
