...
public class QueryResponseBlock  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.vso.Time time;

    private org.astrogrid.solarsearch.ws.vso.Wave wave;

    private org.astrogrid.solarsearch.ws.vso.Extent extent;

    private java.lang.String fileid;

    private java.lang.Float size;

    private org.astrogrid.solarsearch.ws.vso.Extra extra;
    ...
    public QueryResponseBlock(
           ...
           org.astrogrid.solarsearch.ws.vso.Time time,
           org.astrogrid.solarsearch.ws.vso.Wave wave,
           org.astrogrid.solarsearch.ws.vso.Extent extent,
           java.lang.String fileid,
           java.lang.Float size,
           org.astrogrid.solarsearch.ws.vso.Extra extra,
     ...
     * @return time
     */
    public org.astrogrid.solarsearch.ws.vso.Time getTime() {
        return time;
    }
     ...
     * @param time
     */
    public void setTime(org.astrogrid.solarsearch.ws.vso.Time time) {
        this.time = time;
    }
     ...
     * @return wave
     */
    public org.astrogrid.solarsearch.ws.vso.Wave getWave() {
        return wave;
    }
     ...
     * @param wave
     */
    public void setWave(org.astrogrid.solarsearch.ws.vso.Wave wave) {
        this.wave = wave;
    }
     ...
     * @return extent
     */
    public org.astrogrid.solarsearch.ws.vso.Extent getExtent() {
        return extent;
    }
     ...
     * @param extent
     */
    public void setExtent(org.astrogrid.solarsearch.ws.vso.Extent extent) {
        this.extent = extent;
    }
     ...
     * @return extra
     */
    public org.astrogrid.solarsearch.ws.vso.Extra getExtra() {
        return extra;
    }
     ...
     * @param extra
     */
    public void setExtra(org.astrogrid.solarsearch.ws.vso.Extra extra) {
        this.extra = extra;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://virtualsolar.org/VSO/VSOi_strict", "QueryResponseBlock"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://virtualsolar.org/VSO/VSOi_strict", "Extra"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
