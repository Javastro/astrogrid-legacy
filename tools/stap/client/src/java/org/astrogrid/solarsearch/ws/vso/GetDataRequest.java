...
public class GetDataRequest  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.vso.Info info;

    private org.astrogrid.solarsearch.ws.vso.DataRequest[] data;
    ...
    public GetDataRequest(
           ...
           org.astrogrid.solarsearch.ws.vso.Info info,
           org.astrogrid.solarsearch.ws.vso.DataRequest[] data) {
           this.method = method;
           this.info = info;
           this.data = data;
    }
     ...
     * @return info
     */
    public org.astrogrid.solarsearch.ws.vso.Info getInfo() {
        return info;
    }
     ...
     * @param info
     */
    public void setInfo(org.astrogrid.solarsearch.ws.vso.Info info) {
        this.info = info;
    }
     ...
     * @return data
     */
    public org.astrogrid.solarsearch.ws.vso.DataRequest[] getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(org.astrogrid.solarsearch.ws.vso.DataRequest[] data) {
        this.data = data;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://virtualsolar.org/VSO/VSOi_strict", "GetDataRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://virtualsolar.org/VSO/VSOi_strict", "Info"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://virtualsolar.org/VSO/VSOi_strict", "DataRequest"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
