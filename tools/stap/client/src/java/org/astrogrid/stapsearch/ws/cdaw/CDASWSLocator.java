...
public class CDASWSLocator extends org.apache.axis.client.Service implements org.astrogrid.stapsearch.ws.cdaw.CDASWS {
    ...
    public org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystem getCoordinatedDataAnalysisSystemPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystem getCoordinatedDataAnalysisSystemPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystemBindingStub _stub = new org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystemBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystem.class.isAssignableFrom(serviceEndpointInterface)) {
                org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystemBindingStub _stub = new org.astrogrid.stapsearch.ws.cdaw.CoordinatedDataAnalysisSystemBindingStub(new java.net.URL(CoordinatedDataAnalysisSystemPort_address), this);
                _stub.setPortName(getCoordinatedDataAnalysisSystemPortWSDDServiceName());
                return _stub;
            }
        }
