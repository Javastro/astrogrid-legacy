...
public class VSOGetDataRequest  implements java.io.Serializable {
    ...
    private org.astrogrid.stapsearch.ws.vso.GetDataRequest request;
    ...
    public VSOGetDataRequest(
           ...
           org.astrogrid.stapsearch.ws.vso.GetDataRequest request) {
     ...
     * @return request
     */
    public org.astrogrid.stapsearch.ws.vso.GetDataRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.astrogrid.stapsearch.ws.vso.GetDataRequest request) {
        this.request = request;
    }
