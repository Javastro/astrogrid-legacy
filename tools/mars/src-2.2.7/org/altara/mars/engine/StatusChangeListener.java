...
/** Interface implemented by parties interested in service status changes.
	Defines one method, statusChanged(), which is called by Controller
	when a Probe notifies it of a status change.
*/
