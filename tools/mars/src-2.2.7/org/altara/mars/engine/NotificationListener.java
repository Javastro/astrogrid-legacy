...
/** Interface implemented by parties interested in service status changes
    for notification purposes.  Defines one method, notifyStatusChanged(),
    which is called by Controller when a the Notifier notifies it of a
    status change that has stabilized for long enough to warrant notification.
*/
