...
/** Wraps a StatusChangeListener to ensure statusChanged() is called in the
	Swing event dispatch thread.
*/

public class StatusChangeThreadAdapter implements StatusChangeListener {

	private StatusChangeListener inner;

	public StatusChangeThreadAdapter(StatusChangeListener inner) {
		this.inner = inner;
	}
