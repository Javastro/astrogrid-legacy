...
public class DatasetDescription  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.cdaw.DatasetLink[] links;
    ...
    public DatasetDescription(
           ...
           org.astrogrid.solarsearch.ws.cdaw.DatasetLink[] links,
     ...
     * @return links
     */
    public org.astrogrid.solarsearch.ws.cdaw.DatasetLink[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(org.astrogrid.solarsearch.ws.cdaw.DatasetLink[] links) {
        this.links = links;
    }
