...
public class ProviderQueryResponse  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.vso.QueryResponseBlock[] record;
    ...
    public ProviderQueryResponse(
           ...
           org.astrogrid.solarsearch.ws.vso.QueryResponseBlock[] record,
     ...
     * @return record
     */
    public org.astrogrid.solarsearch.ws.vso.QueryResponseBlock[] getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(org.astrogrid.solarsearch.ws.vso.QueryResponseBlock[] record) {
        this.record = record;
    }
