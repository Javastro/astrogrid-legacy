...
public class VSOGetDataRequest  implements java.io.Serializable {
    ...
    private org.astrogrid.solarsearch.ws.vso.GetDataRequest request;
    ...
    public VSOGetDataRequest(
           ...
           org.astrogrid.solarsearch.ws.vso.GetDataRequest request) {
     ...
     * @return request
     */
    public org.astrogrid.solarsearch.ws.vso.GetDataRequest getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.astrogrid.solarsearch.ws.vso.GetDataRequest request) {
        this.request = request;
    }
