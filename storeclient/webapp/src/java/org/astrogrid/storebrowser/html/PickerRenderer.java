/**
 * $Id: PickerRenderer.java,v 1.1.1.1 2005/02/16 15:02:46 mch Exp $
 */
   ...
   public void newStoreForm(Writer out) throws IOException, URISyntaxException {
        ...
        //selected path is a folder
         out.write(
            ...
            "<p><a href='"+refRoot+"?addStore=SRB-SDSC&addStoreUri='"+JargonFileAdaptor.DEMO_SRB_URI+"'>Storage Resource Broker at SDSC</a>"+
            "</body></html>"
         );
   }
