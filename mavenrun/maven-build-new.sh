...
echo "Build Log for $PROJECT_NAME HEAD on $DATE" >> $LOG_FILE 2>&1
echo "====================================" >> $LOG_FILE 2>&1
...
echo `date` "[ag-build-$PROJECT_NAME] generate and deploy binaries"
...
scp $LOG_FILE maven@uluru.star.le.ac.uk:/home/maven/maven/docs/HEAD/log
